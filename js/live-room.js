...
, function(e, t, n) {
    (function(t, n) {
        ...
        function k(e, t) {
            if (p(e)) {
                var n;
                return s(e, "__ob__") && e.__ob__ instanceof br ? n = e.__ob__ : yr.shouldConvert && !tr() && (Array.isArray(e) || h(e)) && Object.isExtensible(e) && !e._isVue && (n = new br(e)),
                t && n && n.vmCount++,
                n
            }
        }
        function M(e, n, r, o) {
            ...
            if (!a || !1 !== a.configurable) {
                ...
                Object.defineProperty(e, n, {
                    ...
                    set: function(n) {
                        var a = s ? s.call(e) : r;
                        n === a || n !== n && a !== a || ("production" !== t.env.NODE_ENV && o && o(),
                        l ? l.call(e, n) : r = n,
                        c = k(n),
                        i.notify())
                    }
        ...
        function A(e, n, r) {
            ...
            if (s(e, n))
                ...
                r;
            var o = e.__ob__;
            return e._isVue || o && o.vmCount ? ("production" !== t.env.NODE_ENV && ar("Avoid adding reactive properties to a Vue instance or its root $data at runtime - declare it upfront in the data option."),
            r) : o ? (M(o.value, n, r),
            o.dep.notify(),
            r) : (e[n] = r,
            r)
        ...
        function L(e, n) {
            if (Array.isArray(e) && "number" == typeof n)
                ...
                var r = e.__ob__;
                e._isVue || r && r.vmCount ? "production" !== t.env.NODE_ENV && ar("Avoid deleting properties on a Vue instance or its root $data - just set it to null.") : s(e, n) && (delete e[n],
                r && r.dep.notify())
            }
        }
        function N(e) {
        ...
        function j(e) {
            for (var t in e.components) {
                var n = t.toLowerCase();
                (Nn(n) || zn.isReservedTag(n)) && ar("Do not use built-in or reserved HTML elements as component id: " + t)
            }
        }
        function D(e) {
            var n = e.props;
        ...
        function B(e, n, r) {
            ...
            "production" !== t.env.NODE_ENV && j(n),
            D(n),
            X(n);
            var i = n.extends;
            if (i && (e = "function" == typeof i ? B(e, i.options, r) : B(e, i, r)),
            n.mixins)
                for (var a = 0, l = n.mixins.length; a < l; a++) {
                    var c = n.mixins[a];
                    c.prototype instanceof lt && (c = c.options),
                    e = B(e, c, r)
                }
            var u, d = {};
            for (u in e)
        ...
        function U(e, n, r, o) {
            if ("string" == typeof r) {
                ...
                if (s(i, l))
                    return i[l];
                var c = i[r] || i[a] || i[l];
                return "production" !== t.env.NODE_ENV && o && !c && ar("Failed to resolve " + n.slice(0, -1) + ": " + r, e),
                c
            }
        }
        function V(e, n, r, o) {
            var i = n[e]
              , a = !s(r, e)
              , l = r[e];
            if (q(Boolean, i.type) && (a && !s(i, "default") ? l = !1 : q(String, i.type) || "" !== l && l !== Xn(e) || (l = !0)),
            void 0 === l) {
                l = H(o, i, e);
            ...
            return "production" !== t.env.NODE_ENV && z(i, e, l, o, a),
            l
        }
        function H(e, n, r) {
            if (s(n, "default")) {
                var o = n.default;
                return "production" !== t.env.NODE_ENV && p(o) && ar('Invalid default value for prop "' + r + '": Props with type Object/Array must use a factory function to return the default value.', e),
                e && e.$options.propsData && void 0 === e.$options.propsData[r] && void 0 !== e._props[r] ? e._props[r] : "function" == typeof o && "Function" !== G(n.type) ? o.call(e) : o
            }
        }
        ...
        function J(e, n, r) {
            if (zn.errorHandler)
                ...
                if ("production" !== t.env.NODE_ENV && ar("Error in " + r + ":", n),
                !Jn || "undefined" == typeof console)
                    throw e;
                console.error(e)
            }
        }
        function Y(e) {
            return new Nr(void 0,void 0,void 0,String(e))
        }
        function W(e) {
            var t = new Nr(e.tag,e.data,e.children,e.text,e.elm,e.context,e.componentOptions);
            return t.ns = e.ns,
        ...
        function $(e, n, r, o, i) {
            ...
            for (a in e)
                ...
                c = jr(a),
                s ? l ? s !== l && (l.fns = s,
                e[a] = l) : (s.fns || (s = e[a] = Q(s)),
                r(c.name, s, c.once, c.capture)) : "production" !== t.env.NODE_ENV && ar('Invalid handler for event "' + c.name + '": got ' + String(s), i);
            for (a in n)
        ...
        function Z(e, t, n) {
            ...
            var o, i = e[t];
            i ? i.fns && i.merged ? (o = i).fns.push(r) : o = Q([i, r]) : o = Q([r]),
            o.merged = !0,
            e[t] = o
        }
        function ee(e) {
        ...
        function ne(e, t) {
            ...
            for (n = 0; n < e.length; n++)
                ...
                Array.isArray(r) ? i.push.apply(i, ne(r, (t || "") + "_" + n)) : l(r) ? o && o.text ? o.text += String(r) : "" !== r && i.push(Y(r)) : r.text && o && o.text ? i[i.length - 1] = Y(o.text + r.text) : (r.tag && null == r.key && null != t && (r.key = "__vlist" + t + "_" + n + "__"),
                i.push(r)));
            return i
        }
        function re(e) {
        ...
        function fe(e, n, r) {
            e.$el = n,
            e.$options.render || (e.$options.render = Pr,
            "production" !== t.env.NODE_ENV && (e.$options.template && "#" !== e.$options.template.charAt(0) || e.$options.el || n ? ar("You are using the runtime-only build of Vue where the template compiler is not available. Either pre-compile the templates into render functions, or use the compiler-included build.", e) : ar("Failed to mount component: template or render function not defined.", e))),
            ge(e, "beforeMount");
            var o;
        ...
        function pe(e, n, r, o, i) {
            ...
            n && e.$options.props) {
                yr.shouldConvert = !1,
                "production" !== t.env.NODE_ENV && (yr.isSettingProps = !0);
                for (var s = e._props, l = e.$options._propKeys || [], c = 0; c < l.length; c++) {
                    var u = l[c];
                    s[u] = V(u, e.$options.props, n, e)
                }
                yr.shouldConvert = !0,
                "production" !== t.env.NODE_ENV && (yr.isSettingProps = !1),
        ...
        function be() {
            ...
            zr = 0; zr < Xr.length; zr++)
                ...
                Br[n] = null,
                e.run(),
                "production" !== t.env.NODE_ENV && null != Br[n] && (Ur[n] = (Ur[n] || 0) + 1,
                Ur[n] > zn._maxUpdateCount)) {
        ...
        function Te(e) {
            e._watchers = [];
            var t = e.$options;
            t.props && Se(e, t.props),
            t.methods && Le(e, t.methods),
            t.data ? Ce(e) : k(e._data = {}, !0),
            t.computed && ke(e, t.computed),
            t.watch && Ne(e, t.watch)
        }
        function Se(e, n) {
            ...
            for (var s in n)
                !function(a) {
                    i.push(a);
                    var s = V(a, n, r, e);
                    "production" !== t.env.NODE_ENV ? (Yr[a] && ar('"' + a + '" is a reserved attribute and cannot be used as component prop.', e),
                    M(o, a, s, function() {
        ...
        function Ce(e) {
            ...
            h(n = e._data = "function" == typeof n ? Oe(n, e) : n || {}) || (n = {},
            "production" !== t.env.NODE_ENV && ar("data functions should return an object:\nhttps://vuejs.org/v2/guide/components.html#data-Must-Be-a-Function", e));
        ...
        function ke(e, n) {
            ...
            for (var o in n) {
                ...
                "production" !== t.env.NODE_ENV && void 0 === a && (ar('No getter function has been defined for computed property "' + o + '".', e),
                a = m),
                r[o] = new Gr(e,a,m,Wr),
                o in e || Me(e, o, i)
            }
        ...
        function Me(e, t, n) {
            "function" == typeof n ? (Jr.get = Ae(t),
            Jr.set = m) : (Jr.get = n.get ? !1 !== n.cache ? Ae(t) : n.get : m,
            Jr.set = n.set ? n.set : m),
        ...
        function Le(e, n) {
            ...
            for (var o in n)
                e[o] = null == n[o] ? m : u(n[o], e),
                "production" !== t.env.NODE_ENV && (null == n[o] && ar('method "' + o + '" has an undefined value in the component definition. Did you reference the function correctly?', e),
                r && s(r, o) && ar('method "' + o + '" has already been defined as a prop.', e))
        }
        function Ne(e, t) {
            for (var n in t) {
                var r = t[n];
                ...
                "function" == typeof e) {
                    if (!e.cid)
                        if (e.resolved)
                            ...
                            return;
                    it(e),
                    (n = n || {}).model && He(e.options, n);
                    var s = Xe(n, e, i);
                    if (e.options.functional)
                        return Pe(e, s, n, r, o);
                    var l = n.on;
                    n.on = n.nativeOn,
                    e.options.abstract && (n = {}),
                    Ue(n);
                    var c = e.options.name || i;
                    return new Nr("vue-component-" + e.cid + (c ? "-" + c : ""),n,void 0,void 0,void 0,r,{
                        Ctor: e,
                        propsData: s,
                        listeners: l,
                        tag: i,
        ...
        function Pe(e, t, n, r, o) {
            ...
            return c instanceof Nr && (c.functionalContext = r,
        ...
        function De(e, n, r) {
            if (!e.requested) {
                ...
                var o = e.pendingCallbacks = [r]
                  ...
                  , l = e(a, s);
                return l && "function" == typeof l.then && !e.resolved && l.then(a, s),
                i = !1,
                e.resolved
            }
        ...
        function ze(e, t, n, r, o, i) {
            return (Array.isArray(n) || l(n)) && (o = r,
            r = n,
            n = void 0),
            i && (o = Zr),
            Fe(e, t, n, r, o)
        ...
        function Fe(e, n, r, o, i) {
            ...
            o.length = 0),
            i === Zr ? o = te(o) : i === $r && (o = ee(o));
            var a, s;
            if ("string" == typeof n) {
                var l;
                s = zn.getTagNamespace(n),
                a = zn.isReservedTag(n) ? new Nr(zn.parsePlatformTagName(n),r,o,void 0,void 0,e) : (l = U(e.$options, "components", n)) ? Re(l, r, e, o, n) : new Nr(n,r,o,void 0,void 0,e)
            } else
                a = Re(n, r, e, o);
            return a ? (s && Ge(a, s),
            a) : Pr()
        ...
        function Je(e, n, r, o) {
            ...
            if (i)
                ...
                i(r) || n;
            var a = this.$slots[e];
            return a && "production" !== t.env.NODE_ENV && (a._rendered && ar('Duplicate presence of slot "' + e + '" found in the same render tree - this will likely cause render errors.', this),
            a._rendered = !0),
            a || n
        }
        function Ye(e) {
        ...
        function Qe(e, t) {
            ...
            return n && !t ? Array.isArray(n) ? K(n) : W(n) : (n = this._staticTrees[e] = this.$options.staticRenderFns[e].call(this._renderProxy),
            Ze(n, "__static__" + e, !1),
            n)
        }
        function $e(e, t, n) {
        ...
        function it(e) {
            ...
            if (e.super) {
                ...
                if (n !== e.superOptions) {
                    ...
                    (t = e.options = B(n, e.extendOptions)).name && (t.components[t.name] = e)
                }
            }
            return t
        }
        ...
        function lt(e) {
            "production" === t.env.NODE_ENV || this instanceof lt || ar("Vue is a constructor and should be called with the `new` keyword"),
            this._init(e)
        }
        function ct(e) {
            e.use = function(e) {
        ...
        function dt(e) {
            ...
            e.extend = function(e) {
                ...
                s.cid = n++,
                s.options = B(r.options, e),
                s.super = r,
                s.options.props && ft(s),
                s.options.computed && pt(s),
                s.extend = r.extend,
                s.mixin = r.mixin,
                s.use = r.use,
        ...
        function ht(e) {
            zn._assetTypes.forEach(function(n) {
                e[n] = function(e, r) {
                    return r ? ("production" !== t.env.NODE_ENV && "component" === n && zn.isReservedTag(e) && ar("Do not use built-in or reserved HTML elements as component id: " + e),
                    "component" === n && h(r) && (r.name = r.name || e,
        ...
        function yt(e) {
            e && (e.componentInstance._inactive || ge(e.componentInstance, "deactivated"),
        ...
        function Tt(e) {
            if ("string" == typeof e) {
                ...
                return n || ("production" !== t.env.NODE_ENV && ar("Cannot find element: " + e),
        ...
        function Nt(e, t) {
            (e.data.directives || t.data.directives) && It(e, t)
        }
        function It(e, t) {
            var n, r, o, i = e === _o, a = t === _o, s = Rt(e.data.directives, e.context), l = Rt(t.data.directives, t.context), c = [], u = [];
            for (n in l)
                r = s[n],
                o = l[n],
                r ? (o.oldValue = r.value,
                jt(o, "update", t, e),
                o.def && o.def.componentUpdated && u.push(o)) : (jt(o, "bind", t, e),
        ...
        function Rt(e, t) {
            ...
            for (r = 0; r < e.length; r++)
                (o = e[r]).modifiers || (o.modifiers = xo),
                n[Pt(o)] = o,
                o.def = U(t.$options, "directives", o.name, !0);
            return n
        }
        function Pt(e) {
        ...
        function Ut(e) {
            var t;
            e[Oo] && (e[t = Wn ? "change" : "input"] = [].concat(e[Oo], e[t] || []),
            delete e[Oo]),
            e[ko] && (e[t = er ? "click" : "change"] = [].concat(e[ko], e[t] || []),
            delete e[ko])
        }
        function Vt(e, t, n, r) {
            if (n) {
        ...
        function Gt(e, t, n) {
            return !e.composing && ("option" === t.tag || qt(e, n) || Jt(e, n))
        }
        function qt(e, t) {
        ...
        function Wt(e) {
            return Array.isArray(e) ? v(e) : "string" == typeof e ? Lo(e) : e
        }
        function Kt(e, t) {
            var n, r = {};
            if (t)
        ...
        function Qt(e, t) {
            ...
            if (n.staticStyle || n.style || r.staticStyle || r.style) {
                var o, i, a = t.elm, s = e.data.staticStyle, l = e.data.style || {}, c = s || l, u = Wt(t.data.style) || {};
        ...
        function en(e) {
            if (e) {
                if ("object" == typeof e) {
                    var t = {};
                    return !1 !== e.css && f(t, Xo(e.name || "v")),
                    f(t, e),
                    t
                }
        ...
        function an(e, t) {
            var n, r = window.getComputedStyle(e), o = r[Ho + "Delay"].split(", "), i = r[Ho + "Duration"].split(", "), a = sn(o, i), s = r[Fo + "Delay"].split(", "), l = r[Fo + "Duration"].split(", "), c = sn(s, l), u = 0, d = 0;
            return t === Uo ? a > 0 && (n = Uo,
            u = a,
            d = i.length) : t === Vo ? c > 0 && (n = Vo,
            u = c,
            d = l.length) : d = (n = (u = Math.max(a, c)) > 0 ? a > c ? Uo : Vo : null) ? n === Uo ? i.length : l.length : 0,
            {
                type: n,
                timeout: u,
                propCount: d,
                hasTransform: n === Uo && Jo.test(r[Ho + "Property"])
            }
        }
        function sn(e, t) {
            ...
            if (i && !r._enterCb && 1 === r.nodeType) {
                ...
                if (!O || w || "" === w) {
                    ...
                    tn(function() {
                        nn(r, A),
                        rn(r, k),
                        X.cancelled || D || (fn(P) ? setTimeout(X, P) : on(r, s, X))
                    })),
                    e.data.show && (n && n(),
                    N && N(r, X)),
                    j || D || X()
        ...
        function un(e, n) {
            function r() {
                x.cancelled || (e.data.show || ((i.parentNode._pending || (i.parentNode._pending = {}))[e.key] = e),
                f && f(i),
                _ && (nn(i, c),
                nn(i, d),
                tn(function() {
                    nn(i, u),
                    rn(i, c),
                    x.cancelled || w || (fn(E) ? setTimeout(x, E) : on(i, l, x))
                })),
                h && h(i, x),
                _ || w || x())
            }
        ...
        var An, Ln, Nn = i("slot,component", !0), In = Object.prototype.hasOwnProperty, Rn = /-(\w)/g, Pn = c(function(e) {
            return e.replace(Rn, function(e, t) {
                return t ? t.toUpperCase() : ""
            })
        }), jn = c(function(e) {
            return e.charAt(0).toUpperCase() + e.slice(1)
        }), Dn = /([^-])([A-Z])/g, Xn = c(function(e) {
            return e.replace(Dn, "$1-$2").replace(Dn, "$1-$2").toLowerCase()
        }), Bn = Object.prototype.toString, Un = "[object Object]", Vn = function() {
            return !1
        }, Hn = function(e) {
            return e
        }, zn = {
            ...
            _maxUpdateCount: 100
        }, Fn = Object.freeze({}), Gn = /[^\w.$]/, qn = "__proto__"in {}, Jn = "undefined" != typeof window, Yn = Jn && window.navigator.userAgent.toLowerCase(), Wn = Yn && /msie|trident/.test(Yn), Kn = Yn && Yn.indexOf("msie 9.0") > 0, Qn = Yn && Yn.indexOf("edge/") > 0, $n = Yn && Yn.indexOf("android") > 0, Zn = Yn && /iphone|ipad|ipod|ios/.test(Yn), er = Yn && /chrome\/\d+/.test(Yn) && !Qn, tr = function() {
            return void 0 === An && (An = !Jn && void 0 !== n && "server" === n.process.env.VUE_ENV),
            An
        }, nr = Jn && window.__VUE_DEVTOOLS_GLOBAL_HOOK__, rr = "undefined" != typeof Symbol && x(Symbol) && "undefined" != typeof Reflect && x(Reflect.ownKeys), or = function() {
            function e() {
                r = !1;
                var e = n.slice(0);
                n.length = 0;
        ...
        Ln = "undefined" != typeof Set && x(Set) ? Set : function() {
            function e() {
        ...
        var gr = Object.getOwnPropertyNames(mr)
          ...
          , br = function(e) {
            ...
            this.vmCount = 0,
            w(e, "__ob__", this),
            Array.isArray(e) ? ((qn ? C : O)(e, mr, gr),
        ...
        _r.data = function(e, n, r) {
            ...
            : void 0 : n ? "function" != typeof n ? ("production" !== t.env.NODE_ENV && ar('The "data" option should be a function that returns a per-instance value in component definitions.', r),
            e) : e ? function() {
        ...
        if ("production" !== t.env.NODE_ENV) {
            ...
            if (Sr) {
                ...
                zn.keyCodes = new Proxy(zn.keyCodes,{
                    set: function(e, t, n) {
                        return Cr(t) ? (ar("Avoid overwriting built-in modifier in config.keyCodes: ." + t),
                        !1) : (e[t] = n,
                        !0)
                    }
                })
            ...
            var Or = {
              ...
              , kr = {
                get: function(e, t) {
                    return "string" != typeof t || t in e || Tr(e, t),
                    e[t]
                }
            };
            wr = function(e) {
        ...
        var Mr, Ar;
        if ("production" !== t.env.NODE_ENV) {
            var Lr = Jn && window.performance;
            Lr && Lr.mark && Lr.measure && Lr.clearMarks && Lr.clearMeasures && (Mr = function(e) {
                return Lr.mark(e)
            }
            ,
            Ar = function(e, t, n) {
        ...
        Ir.child.get = function() {
            return this.componentInstance
        }
        ,
        Object.defineProperties(Nr.prototype, Ir);
        var Rr, Pr = function() {
            var e = new Nr;
            return e.text = "",
            e.isComment = !0,
        ...
        }), Dr = null, Xr = [], Br = {}, Ur = {}, Vr = !1, Hr = !1, zr = 0, Fr = 0, Gr = function(e, n, r, o) {
            this.vm = e,
            e._watchers.push(this),
            o ? (this.deep = !!o.deep,
            this.user = !!o.user,
            this.lazy = !!o.lazy,
            this.sync = !!o.sync) : this.deep = this.user = this.lazy = this.sync = !1,
            this.cb = r,
            this.id = ++Fr,
            this.active = !0,
            ...
            "function" == typeof n ? this.getter = n : (this.getter = E(n),
            this.getter || (this.getter = function() {}
            ,
            "production" !== t.env.NODE_ENV && ar('Failed watching path: "' + n + '" Watcher only accepts simple dot-delimited paths. For full control, use a function instead.', e))),
        ...
        var qr = new Ln
          ...
          , Kr = {
            ...
            insert: function(e) {
                ...
                ge(e.componentInstance, "mounted")),
                e.data.keepAlive && ve(e.componentInstance, !0)
            },
            destroy: function(e) {
        ...
        !function(e) {
            e.prototype._init = function(e) {
                ...
                n._uid = eo++;
                var r, o;
                "production" !== t.env.NODE_ENV && zn.performance && Mr && (r = "vue-perf-init:" + n._uid,
                o = "vue-perf-end:" + n._uid,
                Mr(r)),
                n._isVue = !0,
                e && e._isComponent ? ot(n, e) : n.$options = B(it(n.constructor), e || {}, n),
                "production" !== t.env.NODE_ENV ? wr(n) : n._renderProxy = n,
                n._self = n,
                de(n),
                oe(n),
                tt(n),
                ...
                nt(n),
                ge(n, "created"),
                "production" !== t.env.NODE_ENV && zn.performance && Mr && (n._name = ir(n, !1),
                Mr(o),
                Ar(n._name + " init", r, o)),
        ...
        function(e) {
            ...
            e.prototype.$on = function(e, t) {
                ...
                if (Array.isArray(e))
                    ...
                    (o._events[e] || (o._events[e] = [])).push(t),
        ...
        function(e) {
            ...
            e.prototype._render = function() {
                ...
                e.$scopedSlots = i && i.data.scopedSlots || Fn,
                ...
                try {
                    ...
                    J(n, e, "render function"),
                    s = "production" !== t.env.NODE_ENV && e.$options.renderError ? e.$options.renderError.call(e._renderProxy, e.$createElement, n) : e._vnode
                }
                return s instanceof Nr || ("production" !== t.env.NODE_ENV && Array.isArray(s) && ar("Multiple root nodes returned from render function. Render function should return a single root node.", e),
                s = Pr()),
                s.parent = i,
                s
            }
        ...
        lt.version = "2.2.6";
        var ro, oo, io = i("input,textarea,option,select"), ao = i("contenteditable,draggable,spellcheck"), so = i("allowfullscreen,async,autofocus,autoplay,checked,compact,controls,declare,default,defaultchecked,defaultmuted,defaultselected,defer,disabled,enabled,formnovalidate,hidden,indeterminate,inert,ismap,itemscope,loop,multiple,muted,nohref,noresize,noshade,novalidate,nowrap,open,pauseonexit,readonly,required,reversed,scoped,seamless,selected,sortable,translate,truespeed,typemustmatch,visible"), lo = "http://www.w3.org/1999/xlink", co = function(e) {
            ...
            update: function(e, t) {
                e.data.ref !== t.data.ref && (St(e, !0),
                St(t))
            },
            destroy: function(e) {
                St(e, !0)
            }
        }, _o = new Nr("",{},[]), wo = ["create", "activate", "update", "remove", "destroy"], Eo = {
            create: Nt,
            update: Nt,
            destroy: function(e) {
                Nt(e, _o)
            }
        }, xo = Object.create(null), To = [bo, Eo], So = {
            create: Dt,
            update: Dt
        }, Co = {
            create: Bt,
            ...
            t
        }), No = /^--/, Io = /\s*!important$/, Ro = function(e, t, n) {
            No.test(t) ? e.style.setProperty(t, n) : Io.test(n) ? e.style.setProperty(t, n.replace(Io, ""), "important") : e.style[jo(t)] = n
        }, Po = ["Webkit", "Moz", "ms"], jo = c(function(e) {
            if (oo = oo || document.createElement("div"),
            "filter" !== (e = Pn(e)) && e in oo.style)
                return e;
        ...
        }), Bo = Jn && !Kn, Uo = "transition", Vo = "animation", Ho = "transition", zo = "transitionend", Fo = "animation", Go = "animationend";
        Bo && (void 0 === window.ontransitionend && void 0 !== window.onwebkittransitionend && (Ho = "WebkitTransition",
        ...
        var qo = Jn && window.requestAnimationFrame ? window.requestAnimationFrame.bind(window) : setTimeout
          , Jo = /\b(transform|all)(,|$)/
          , Yo = function(e) {
            function n(e) {
                return new Nr(M.tagName(e).toLowerCase(),{},[],void 0,e)
            }
            function r(e, t) {
                function n() {
                    0 == --n.listeners && o(e)
            ...
            function a(e, n, r, o, i) {
                ...
                !s(e, n, r, o)) {
                    var a = e.data
                      , l = e.children
                      , c = e.tag;
                    Ot(c) ? ("production" !== t.env.NODE_ENV && (a && a.pre && A++,
                    A || e.ns || zn.ignoredElements.length && zn.ignoredElements.indexOf(c) > -1 || !zn.isUnknownElement(c) || ar("Unknown custom element: <" + c + '> - did you register the component correctly? For recursive components, make sure to provide the "name" option.', e.context)),
                    e.elm = e.ns ? M.createElementNS(e.ns, c) : M.createElement(c, e),
                    v(e),
                    f(e, l, n),
                    Ot(a) && h(e, n),
                    d(r, e.elm, o),
                    "production" !== t.env.NODE_ENV && a && a.pre && A--) : kt(e.isComment) ? (e.elm = M.createComment(e.text),
                    d(r, e.elm, o)) : (e.elm = M.createTextNode(e.text),
                    d(r, e.elm, o))
                }
            }
            function s(e, t, n, r) {
                ...
                if (Ot(o)) {
                    ...
                    if (Ot(o = o.hook) && Ot(o = o.init) && o(e, !1, n, r),
                    Ot(e.componentInstance))
                        return c(e, t),
                        kt(i) && u(e, t, n, r),
                        !0
                }
            ...
            function c(e, t) {
                Ot(e.data.pendingInsert) && t.push.apply(t, e.data.pendingInsert),
            ...
            function h(e, t) {
                for (var n = 0; n < O.create.length; ++n)
                    O.create[n](_o, e);
                Ot(S = e.data.hook) && (Ot(S.create) && S.create(_o, e),
                Ot(S.insert) && t.push(e))
            }
            function v(e) {
                for (var t, n = e; n; )
                    Ot(t = n.context) && Ot(t = t.$options._scopeId) && M.setAttribute(e.elm, t, ""),
                    n = n.parent;
            ...
            function g(e) {
                var t, n, r = e.data;
                if (Ot(r))
                    for (Ot(t = r.hook) && Ot(t = t.destroy) && t(e),
            ...
            function b(e, t) {
                if (Ot(t) || Ot(e.data)) {
                    ...
                    for (Ot(t) ? t.listeners += n : t = r(e.elm, n),
                    Ot(S = e.componentInstance) && Ot(S = S._vnode) && Ot(S.data) && b(S, t),
                    S = 0; S < O.remove.length; ++S)
                        O.remove[S](e, t);
            ...
            function _(e, n, r, o, i) {
                for (var s, l, c, u = 0, d = 0, f = n.length - 1, p = n[0], h = n[f], v = r.length - 1, g = r[0], b = r[v], _ = !i; u <= f && d <= v; )
                    Ct(p) ? p = n[++u] : Ct(h) ? h = n[--f] : Mt(p, g) ? (w(p, g, o),
                    p = n[++u],
                    g = r[++d]) : Mt(h, b) ? (w(h, b, o),
                    h = n[--f],
                    b = r[--v]) : Mt(p, b) ? (w(p, b, o),
                    _ && M.insertBefore(e, p.elm, M.nextSibling(h.elm)),
                    p = n[++u],
                    b = r[--v]) : Mt(h, g) ? (w(h, g, o),
                    _ && M.insertBefore(e, h.elm, p.elm),
                    h = n[--f],
                    g = r[++d]) : (Ct(s) && (s = Lt(n, u, f)),
                    Ct(l = Ot(g.key) ? s[g.key] : null) ? (a(g, o, e, p.elm),
                    g = r[++d]) : (c = n[l],
                    "production" === t.env.NODE_ENV || c || ar("It seems there are duplicate keys that is causing an update error. Make sure each v-for item has a unique key."),
                    Mt(c, g) ? (w(c, g, o),
                    n[l] = void 0,
                    _ && M.insertBefore(e, g.elm, p.elm),
                    g = r[++d]) : (a(g, o, e, p.elm),
                    g = r[++d])));
            ...
            function w(e, t, n, r) {
                if (e !== t) {
                    ...
                    Ct(t.text) ? Ot(s) && Ot(l) ? s !== l && _(a, s, l, n, r) : Ot(l) ? (Ot(e.text) && M.setTextContent(a, ""),
                    m(a, null, l, 0, l.length - 1, n)) : Ot(s) ? y(a, s, 0, s.length - 1) : Ot(e.text) && M.setTextContent(a, "") : e.text !== t.text && M.setTextContent(a, t.text),
                    Ot(i) && Ot(o = i.hook) && Ot(o = o.postpatch) && o(e, t)
                }
            }
            function E(e, t, n) {
                if (kt(n) && Ot(e.parent))
            ...
            function x(e, n, r) {
                ...
                var o = n.tag
                  , i = n.data
                  , a = n.children;
                if (Ot(i) && (Ot(S = i.hook) && Ot(S = S.init) && S(n, !0),
                Ot(S = n.componentInstance)))
                    return c(n, r),
                    !0;
                if (Ot(o)) {
                    if (Ot(a))
                        if (e.hasChildNodes()) {
                            ...
                            if (!s || l)
                                return "production" === t.env.NODE_ENV || "undefined" == typeof console || L || (L = !0,
                                console.warn("Parent: ", e),
                                console.warn("Mismatching childNodes vs. VNodes: ", e.childNodes, a)),
                                !1
                        } else
                            f(n, a, r);
                    if (Ot(i))
            ...
            var S, C, O = {}, k = e.modules, M = e.nodeOps;
            ...
            var A = 0
              , L = !1
              , N = i("attrs,style,class,staticClass,staticStyle,key");
                ...
                if (!Ct(r)) {
                    ...
                    if (Ct(e))
                        ...
                        if (!d && Mt(e, r))
                            ...
                            var f = e.elm
                              , h = M.parentNode(f);
                            if (a(r, u, f._leaveCb ? null : h, M.nextSibling(f)),
                            Ot(r.parent)) {
        ...
        var Wo = {
            model: {
                inserted: function(e, t, n) {
                    if ("select" === n.tag) {
                        ...
                        r(),
                        (Wn || Qn) && setTimeout(r, 0)
                    } else
                        "textarea" !== n.tag && "text" !== e.type && "password" !== e.type || (e._vModifiers = t.modifiers,
                        t.modifiers.lazy || ($n || (e.addEventListener("compositionstart", yn),
                        e.addEventListener("compositionend", bn)),
                        Kn && (e.vmodel = !0)))
                },
                componentUpdated: function(e, t, n) {
                    "select" === n.tag && (vn(e, t, n.context),
            ...
            show: {
                ...
                update: function(e, t, n) {
                    var r = t.value;
                    r !== t.oldValue && ((n = wn(n)).data && n.data.transition && !Kn ? (n.data.show = !0,
                    r ? cn(n, function() {
                ...
                if (r && (r = r.filter(function(e) {
                    ...
                    u && u.data && !Cn(a, u)) {
                        ...
                        if ("in-out" === o) {
                            ...
                            Z(c, "afterEnter", h),
                            Z(c, "enterCancelled", h),
                            Z(d, "delayLeave", function(e) {
                                p = e
                            })
                        }
                    }
                    ...
                    if (e.length && this.hasMove(e[0].elm, t)) {
                        ...
                        e.forEach(function(e) {
                            if (e.data.moved) {
                                ...
                                n.addEventListener(zo, n._moveCb = function e(r) {
                                    r && !/transform$/.test(r.propertyName) || (n.removeEventListener(zo, e),
                                    n._moveCb = null,
                                    rn(n, t))
                                }
                                )
        ...
        ,
        lt.config.isReservedTag = mo,
        lt.config.getTagNamespace = function(e) {
        ...
        ,
        f(lt.options.directives, Wo),
        f(lt.options.components, Zo),
        lt.prototype.__patch__ = Jn ? Yo : m,
        lt.prototype.$mount = function(e, t) {
            return e = e && Jn ? Tt(e) : void 0,
            fe(this, e, t)
        }
        ,
        setTimeout(function() {
            ...
            "production" !== t.env.NODE_ENV && !1 !== zn.productionTip && Jn && "undefined" != typeof console && console[console.info ? "info" : "log"]("You are running Vue in development mode.\nMake sure to turn on production mode when deploying for production.\nSee more tips at https://vuejs.org/guide/deployment.html")
        }, 0),
        e.exports = lt
    }
    ).call(t, n(2), function() {
...
, function(e, t, n) {
    ...
    function(e, t) {
        ...
        function r(e, t) {
            var n, r, o, i = null, a = 0, s = function() {
                a = Date.now(),
                i = null,
                o = e.apply(n, r)
            };
        ...
        function l() {
            ...
            (M = Array.prototype.slice.call(document.querySelectorAll("." + L.class))).length && M.forEach(function(e, t) {
        ...
        function c() {
            ...
            M.length && M.forEach(function(t, n) {
                if ("true" != t.getAttribute("data-src-checked")) {
                    ...
                    o && (s.size = o),
                    i && (s.type = i),
                    t.attributes["data-original"] && (s.isOriginal = !0),
                    null !== a && (s.cancelEXIF = "true" === a),
                    r && (t.setAttribute(e, N.getNewUrl(r, s)),
                    t.setAttribute("data-src-checked", "true"))
                }
            })
        }
        function u() {
            ...
            M.length && M.forEach(function(n, r) {
                ...
                var i = n.getAttribute(e)
                  , l = a(n)
                  , c = s(t, l);
                i && ("wifi" == k && b && L.enalbeIOSWifiLoadMore ? o(n) : c && o(n))
            })
        }
        function d(e) {
                ...
                e.onload = function() {
                    if (!this.getAttribute(L.dataSrc) && "data" != e.src.substring(0, 4)) {
                        ...
                        var l = localStorage.getItem(s)
                          ...
                          , u = c ? JSON.parse(c) : [];
                        if (!l) {
                            if (localStorage.setItem("h5_lib_img_cached_url_" + s, i),
                            u.length >= 200) {
                                var d = u.shift();
                                localStorage.removeItem(d)
                            }
                            u.push("h5_lib_img_cached_url_" + s),
                            localStorage.setItem("h5_lib_img_cached_list", JSON.stringify(u))
                        }
                    }
                }
            }
        ...
        function p(e, t) {
            ...
            switch ("string" == typeof e && e.match(/^\d+x\d+$/) && (e = t == S ? e.split("x")[1] : e.split("x")[0]),
            t) {
            case T:
                n = O.widths;
                break;
        ...
        function h(e) {
            var t = ""
              ...
              , a = x
              , s = e.cancelEXIF;
            switch ("[object Array]" == Object.prototype.toString.call(r) && (r = r[0]),
            e && (e.size && (i = e.size),
            e.type && e.type.match(new RegExp("^(" + [x, T, S, C].join("|") + ")$")) && (a = e.type)),
            t = p(i, a),
            a) {
            case x:
                t = t + "x" + t;
        ...
        function m(e) {
            L = i(L, e = e || {}),
            e.filterDomains && e.filterDomains.length && (O.filterDomains = O.filterDomains.concat(e.filterDomains)),
            L.class = "." !== L.class.charAt(0) ? L.class : L.class.slice(1),
            L.size && (L.defaultSize = p(L.size)),
            o(function() {
                if ("[object Array]" == Object.prototype.toString.call(L.q))
                    if (_)
                        L.q = k ? "wifi" == k ? L.q[0] : L.q[1] : L.q[0];
                    else {
        ...
        var w = "gw.alicdn.com"
          ...
          , C = "xz"
          , O = {};
        O.widths = [110, 150, 170, 220, 240, 290, 450, 570, 580, 620, 790],
        O.heights = [170, 220, 340, 500],
        O.xzs = [72, 80, 88, 90, 100, 110, 120, 145, 160, 170, 180, 200, 230, 270, 290, 310, 360, 430, 460, 580, 640],
        O.square = [16, 20, 24, 30, 32, 36, 40, 48, 50, 60, 64, 70, 72, 80, 88, 90, 100, 110, 120, 125, 128, 145, 180, 190, 200, 200, 210, 220, 230, 240, 250, 270, 300, 310, 315, 320, 336, 360, 468, 490, 540, 560, 580, 600, 640, 720, 728, 760, 970],
        O.filterDomains = ["a.tbcdn.cn", "assets.alicdn.com", "wwc.taobaocdn.com", "wwc.alicdn.com", "cbu01.alicdn.com"];
        var k, M, A = n(), L = {
            class: "lib-img",
            size: "320x320",
            sharpen: "s150",
            ...
            getNewUrl: function(e, n) {
                if (!e || "string" != typeof e)
                    return "";
                var r = L.defaultSize + "x" + L.defaultSize
                  , o = L.q
                  , i = L.cancelEXIF;
                "[object Array]" == Object.prototype.toString.call(o) && (o = o[0]);
                var a = "_" + r + o + L.sharpen;
                i && (a += "g"),
                a += ".jpg";
                try {
                ...
                if (s.protocol,
                s.protocol = "",
                -1 != O.filterDomains.indexOf(l))
                    return /alicdn/.test(l) || (s.protocol = "http:"),
                    s.toString();
                ...
                if (f) {
                    var v;
                    a = "_" + (v = p(parseInt(f[1]) < parseInt(L.defaultSize) ? L.defaultSize : f[1] > 760 ? 760 : f[1])) + "x" + v + o + L.sharpen,
                    i && (a += "g"),
                    a += ".jpg"
                }
                return n && "string" == typeof n ? a = h({
                    size: n,
                    cancelEXIF: i
                }) : n && "object" == typeof n && Object.keys(n).length > 0 && (n.cancelEXIF = i,
                a = h(n)),
                /\.gif/.test(c) && L.diffGif ? s.toString() : (/\.png/.test(c) && (a = a.replace(/(q\d+)(s\d+)/, "")),
                A && (a += "_.webp"),
                d ? d[1] || d[2] || d[3] || d[4] ? s.pathname = c.replace(E, a) : d[0].match(/_\.(jpg|png|gif|jpef)/) && (s.pathname += a) : c.match(/_\.webp$/g) ? s.pathname = c.replace(/_\.webp$/g, a) : s.pathname = c + a,
                s.protocol = "",
                s.toString())
            },
        ...
        Math.floor(65536 * Math.random()))
          ...
          , y = {
            ...
            call: function(e, t, r, o, i, a) {
                ...
                b.registerCall(s, c),
                b.registerGC(s, a),
                y.isAvailable ? b.callMethod(e, t, r, s) : y.onFailure(s, {
            ...
            fireEvent: function(e, t, n) {
                ...
                o.initEvent(e, !1, !0),
                o.param = b.parseData(t || b.getData(n)),
                r.dispatchEvent(o)
            },
            getParam: function(e) {
                return b.getParam(e)
          ...
          , b = {
            ...
            setData: function() {
                this.chunks[g + sid] = this.chunks[g + sid] || [],
                this.chunks[g + sid].push(chunk)
            },
            getData: function(e) {
            ...
            useIframe: function(e, t) {
                var n = v + e
                  , o = h.pop();
                o || ((o = r.createElement("iframe")).setAttribute("frameborder", "0"),
            ...
            onComplete: function(e, t, n) {
                ...
                "string" == typeof u && ((t = t.value || t).ret || (t.ret = [u])),
                "success" === n ? (o && o(t),
                a && a.resolve(t)) : "failure" === n && (i && i(t),
                a && a.reject(t)),
                s ? (this.retrieveIframe(e),
                this.params[m + e] && delete this.params[m + e]) : l && this.chunks[g + e] && delete this.chunks[g + e]
            }
        };
        for (var _ in y)
            u.call(d, _) || (d[_] = y[_])
    }(window, window.lib || (window.lib = {})),
    e.exports = window.lib.windvane
}
, function(e, t) {
    "undefined" == typeof window && (window = {
        ctrl: {},
                ...
                set: function(e) {
                    if ("string" == typeof e) {
                        ...
                        for (var o = 0; o < n.length; o++) {
                            var i = n[o].split("=");
                            if (void 0 !== i[1] && (i[1] = i[1].toString()),
                            i[0])
                                try {
    ...
    (function(e) {
        ...
        parseSrc: function(e) {
            if ("string" == typeof e && e) {
                ...
                var t, n, r = this.el ? this.el.getAttribute("size") || "" : "", o = {}, i = r.match(/^(\d+)x(\d+)$/);
                i ? (t = i[1],
                n = i[2]) : "cover" === r ? this.el && (t = this.el.offsetWidth / window.rem * window.remUnit,
                n = this.el.offsetHeight / window.rem * window.remUnit) : (i = e.match(/^(?:http(?:s)?\:)?\/\/.+\-(\d+)\-(\d+)\.\w+$/)) && (t = i[1],
                n = i[2]),
                o.size = t && n ? this.convertLength(t) + "x" + this.convertLength(n) : "200x200",
                e = this.imgHelper.getNewUrl(e, o),
                this.el.src = e
            }
        },
        update: function(e, t) {
...
, function(e, t, n) {
    ...
    e.exports = function(e, t) {
        void 0 === (t = t || {}).singleton && (t.singleton = v()),
    ...
    t.default = {
        ...
        watch: {
            replayVideos: function() {
                this.replayVideosLoaded = !0,
                lib.img()
            },
            moreVideos: function() {
                this.moreVideosLoaded = !0,
    ...
    t.default = {
        ...
        methods: {
            activeScroll: function() {
                var e = this;
                this.enableScroll = !0,
                this.$refs.itemlist.scrollTop = 509,
                this.$refs.itemlist.addEventListener("scroll", function() {
...
, function(e, t, n) {
    ...
    t.default = {
        ...
        computed: {
            ...
            currentUrl: function() {
                var e = "";
                return this.isReplay ? e = this.video.replayUrl : this.isLive && (e = this.isSafari ? this.currentLv.hlsUrl : this.currentLv.flvUrl),
                e
            },
        ...
        methods: {
            ...
            initMsg: function() {
                ...
                this.msgScope.requestUserList(0, 6).then(function(t) {
                    e.audienceList.list = e.cachedAudienceList.list = t.data,
                    e.audienceList.list.length > 6 && (e.audienceList.list.length = 6)
                }),
                this.msgScope.on("liveJoin", function(t) {
                    var n = t.data;
                    e.cachedAudienceList.total = n.pageViewCount,
                    e.cachedAudienceList.list = n.userList.concat(e.cachedAudienceList.list),
                    e.cachedAudienceList.list.length > 6 && (e.cachedAudienceList.list.length = 6)
                }),
            ...
            replay: function() {
                this.isLive = !1,
                this.isReplay = !0,
                this.myPlayerLive = null
            },
            updateAudienceList: function() {
                this.audienceList.total = this.cachedAudienceList.total,
                this.audienceList.list = this.cachedAudienceList.list
            },
            setLevel: function(e) {
                this.currentLv = e,
                this.activeLv = !1,
...
, function(e, t, n) {
    ...
    t.default = {
        ...
        jsonp: function(e) {
            ...
            return e.noCallback ? n.src = i + "?" + a + "&" + this.getParams(e.data) : n.src = i + "?callback=" + t + a + "&" + this.getParams(e.data),
...
, function(e, t, n) {
    ...
    Array.isArray || r("Array"))
      , v = l.extend({
        initialize: function(e) {
            ...
            s.on("event:cleanHijackQueue@sufei", function() {
                for (var e, n, r, o = [t.currentRequest].concat(t.queue), i = 0; i < o.length; i++)
                    o[i] && (e = (n = o[i].sufeiData) && n.defer,
                    r = n && n.response,
                    e && p.apply(e, [r]))
            }),
            v.superclass.initialize.call(t, e),
            t.setup()
        },
        setup: function() {
            var e = this;
            c.on("start", function(t) {
                ...
                /json/.test(i)) {
                    ...
                    n.success = function(t, r, i) {
                        var l = e.validate(t);
                        l.pass ? (s && s.apply(n.context || n, arguments),
                        n.sufeiData && n.sufeiData.defer && f.apply(n.sufeiData.defer, [d.call(arguments)])) : e.run({
                            url: t.url,
                            config: a({}, n, {
                                sufeiData: {
                                    defer: o,
        ...
        getValidateURI: function(e) {
            ...
            new c({
                ...
                success: function(e) {
                    t.status = 200,
                    s.fire("event:showDialog@sufei", e.url)
                }
            })
        },
      ...
      , m = n(121);
    m.version = "0.1.0",
    m.style = "//g.alicdn.com/sd/sufei/0.1.0/" + m.style,
    new v(m),
    e.exports = {
        IO: c
    }
...
, function(e, t, n) {
    function r() {
        ...
        return e.innerHTML = "\x3c!--[if lte IE 7]><i></i><![endif]--\x3e",
    ...
    function i(e, t) {
        ...
        o ? r.onload = n : r.onreadystatechange = function() {
            /loaded|complete/.test(r.readyState) && n()
        }
        ,
        c.appendChild(r),
        l.createStyleSheet && l.createStyleSheet(e)
    }
    function a(e, t) {
        var n, r = e.sheet;
        if (g)
    ...
    e.exports = f.create({
        ...
        initMessenger: function(e) {
            ...
            p.register("child", function(e) {
                e = o(decodeURIComponent(e)),
                t.validate(e).pass ? e.queryToken ? d.fire("msg:validateSuccess@sufei", e.queryToken) : t.hide() : d.fire("event:showDialog@sufei", e.url)
            })
        },
        show: function(e) {
            var t = this;
        ...
        hide: function() {
            d.fire("event:cleanHijackQueue@sufei"),
            this.dialog && (this.dialog.style.display = "none"),
            d.fire("event:dialogHide@sufei")
        },
        render: function(e) {
            var t = this
            ...
            n.innerHTML = ['<div class="sufei-dialog-mask">', r() ? '<iframe frameborder="none" src="javascript:\'\'"></iframe>' : "", "</div>", '<div class="sufei-dialog-content">', '<iframe id="sufei-dialog-content" frameborder="none" src="' + e + '"></iframe>', '<div class="sufei-dialog-close" id="sufei-dialog-close">关闭</div>', "</div>"].join(""),
            ...
            t.dialog = n,
            t.frame = l.getElementById("sufei-dialog-content"),
        ...
        iosFix: function() {
            var e = l.body
              , t = 0
              , n = this.dialog;
            e.classList.add("sufei-ios-fix-fixed"),
            d.on("event:dialogShow@sufei", function() {
                t = e.scrollTop,
                e.scrollTop = 0,
                n.style.height = Math.max(window.innerHeight, e.scrollHeight) + "px",
                setTimeout(function() {
                    e.scrollTop = 0
                }, 200)
            }),
        ...
        run: function(e) {
            var t = this;
            t.status > 0 && !e.config.sufei ? t.queue.push(e.config) : e.im ? (t.currentRequest = t.currentRequest || e.config,
            t.status = 200,
            d.fire("event:showDialog@sufei", e.url)) : (t.currentRequest = e.config,
            t.status = 100,
            t.getValidateURI(e.url))
        },
        setup: m,
        getValidateURI: m,
        resendRequest: m,
...
, function(e, t) {
    ...
    function r(e) {
        ...
        for (t in e)
            r = e[t],
            n.Mutators.hasOwnProperty(t) ? n.Mutators[t].call(this, r) : this.prototype[t] = r
    }
    function o(e) {
        return e.extend = n.extend,
        e.implement = r,
        e
    }
    function i() {}
...
, function(e, t, n) {
    function r(e) {
        try {
            var t, n, r = e.data.split(s);
            r.length > 1 ? (t = r[0],
            n = r[1]) : (t = (r = o(r[0])).type,
            n = r.content);
    ...
    window.SufeiMessenger = e.exports = {
        initListener: function(e) {
            ...
            c = e.originWin,
            u = e.msgTransfer,
            l && c && u && (l.postMessage ? l.addEventListener ? l.addEventListener("message", r, !1) : l.attachEvent && l.attachEvent("onmessage", r) : "fromFrame" == u ? f.ListenerMessage(c, r) : f.ListenerMessage(l, r))
        },
...
, function(e, t) {
    e.exports = function() {
        ...
        var e, t, n, r, o = {
            ...
            return r && r !== t && i("Expected '" + r + "' instead of '" + t + "'"),
            t = n.charAt(e),
            e += 1,
            t
        }, s = function() {
...
, function(e, t, n) {
    function r(e) {
        ...
        var n, r, o = e.type, s = e.dataType;
        return r = e.uri = l.parse(l.resolve(p, e.url), !0),
        r.query = {},
        "crossDomain"in e || (e.crossDomain = !(r.protocol === h.protocol && r.host === h.host)),
        o = e.type = o.toUpperCase(),
        e.hasContent = !f.test(o),
        e.processData && (n = e.data) && "string" != typeof n && (e.data = a.stringify(n, void 0, void 0, e.serializeArray)),
        s = e.dataType = i.trim(s || "*").split(u),
        "cache"in e || !i.inArray(s[0], ["script", "jsonp"]) || (e.cache = !1),
        e.hasContent || (e.data && i.mix(r.query, a.parse(e.data)),
        !1 === e.cache && (r.query._ksTS = i.now() + "_" + i.guid())),
        e
    }
    function o(e) {
        var t = this;
        if (!(t instanceof o))
            return new o(e);
        o.superclass.constructor.call(t),
        s.Defer(t),
        t.userConfig = e,
        e = r(e),
        i.mix(t, {
        ...
        n = new (m[e.dataType[0]] || m["*"])(t),
        t.transport = n,
        e.contentType && t.setRequestHeader("Content-Type", e.contentType);
        var a, l = e.dataType[0], c = e.timeout, u = e.context, d = e.headers, f = e.accepts;
        ...
        try {
            ...
            t.state < 2 && t._ioReady(-1, e.message || "send error")
        }
        return t
    }
    var i = n(67)
      ...
      , s = n(80)
      , l = n(82)
      , c = /^(?:about|app|app\-storage|.+\-extension|file|widget):$/
      , u = /\s+/
      , d = function(e) {
        return e
    }
    ...
    g.converters.html = g.converters.text;
    var y = {}
      , b = {};
    i.mix(o, {
        preprocessors: y,
        ...
        callPreprocessors: function(e, t) {
            for (var n = (y[e] || []).concat(), r = 0, i = n.length; r < i; r++)
                n[r].call(o, t)
        },
        on: function(e, t) {
            return (b[e] = b[e] || []).push(t),
            o
        },
        detach: function(e, t) {
            if (t) {
...
, function(e, t, n) {
    ...
    o.mix(o, {
        ...
        later: function(e, t, n, r, i) {
            t = t || 0;
            var a, s, l = e, c = o.makeArray(i);
            return "string" == typeof e && (l = r[e]),
            a = function() {
                l.apply(r, c)
            }
            ,
        ...
        buffer: function(e, t, n) {
            function r() {
                r.stop(),
                i = o.later(e, t, 0, n || this, arguments)
            }
            if (-1 === (t = t || 150))
                return function() {
...
, function(e, t, n) {
    ...
    function s(e, t, n, r, o, i, s, l) {
        if (r || !(e in t) || i) {
            ...
            if (o && (p = o.call(n, e, p)),
            i && p && (u.isArray(p) || u.isPlainObject(p)))
                if (l && p[d])
                    t[e] = p[d];
                else {
    ...
    function l(e, t, n, r) {
        ...
        if ("object" == typeof e) {
            var d = e.constructor;
            u.inArray(d, [Boolean, String, Number, Date, RegExp]) ? c = new d(e.valueOf()) : (o = u.isArray(e)) ? c = t ? u.filter(e, t) : e.concat() : (i = u.isPlainObject(e)) && (c = {}),
            r && (e[f] = s = u.guid("c"),
            n[s] = {
                destination: c,
                input: e
    ...
    var c, u = n(69), d = "__MIX_CIRCULAR", f = "__~ks_cloned", p = {}.toString, h = Object.create;
    !function(e, t) {
        for (var n in t)
            e[n] = t[n]
    }(u, {
        each: function(e, t, n) {
            if (e) {
                var r, o, i, a = 0, s = e && e.length, l = s === c || "[object Function]" === p.call(e);
                if (n = n || null,
                l)
                    for (o = "function" == typeof Object.keys ? Object.keys(e) : u.keys(e); a < o.length && (r = o[a],
                    !1 !== t.call(n, e[r], r, e)); a++)
                        ;
                else
        ...
        augment: function(e, t) {
            var n, o, i = u.makeArray(arguments), a = i.length - 2, s = 1, l = i[a], d = i[a + 1];
            for (i[1] = t,
            u.isArray(d) || (l = d,
            d = c,
            a++),
            "boolean" != typeof l && (l = c,
            a++); s < a; s++)
                (n = (o = i[s]).prototype) && (o = u.mix({}, n, !0, r)),
                u.mix(e.prototype, o, l, d);
            return e
        },
        merge: function(e) {
            var t, n = {}, r = (e = u.makeArray(arguments)).length;
            for (t = 0; t < r; t++)
                u.mix(n, e[t]);
            return n
        },
        extend: function(e, t, n, r) {
            ...
            o = i(a, e),
            e.prototype = u.mix(o, e.prototype),
            e.superclass = a,
            n && u.mix(o, n),
            r && u.mix(e, r),
            e
    ...
    e.exports = {
        ...
        stringify: function(e, t, o, a) {
            ...
            for (s in e) {
                ...
                n(d))
                    f.push(s),
                    void 0 !== d && f.push(o, i(d + "")),
                    f.push(t);
                else if (r(d))
                    for (l = 0,
                    u = d.length; l < u; ++l)
                        n(c = d[l]) && (f.push(s, a && "[]" !== p.slice(-2) ? i("[]") : ""),
                        void 0 !== c && f.push(o, i(c + "")),
                        f.push(t))
            }
            return f.pop(),
            f.join("")
...
, function(e, t) {
    ...
    function c(e, t, n) {
        function a(e) {
            try {
                ...
                return window.console && console.error(e.stack || e),
                new l(e)
            }
        }
        function s(e) {
        ...
        function c(e) {
            d || (d = 1,
            u.resolve(a.call(this, e)))
        }
        var u = new i
          , d = 0;
        return r(e) ? o(e, c, function(e) {
            d || (d = 1,
            u.resolve(s.call(this, e)))
        }) : c(e),
        u.promise
    }
    function u(e) {
    ...
    i.prototype = {
        ...
        resolve: function(e) {
            var t = this.promise;
            return t[p] !== m ? null : (t[p] = e instanceof l ? y : g,
            t[f] = e,
            n(t[v], function(e) {
                o(t, e[0], e[1])
            }),
    ...
    (s.prototype = {
        constructor: s,
        then: function(e, t, n) {
            return n && this.progress(n),
            c(this, e, t)
        },
        progress: function(e) {
            var t = this
              , n = t[h];
            return t[p] !== m ? t : (n || (n = t[h] = []),
            n.push(e),
            t)
        },
        fail: function(e) {
    ...
    var a = n(75)
      ...
      , p = {
        parse: function(e, t) {
            ...
            for (var i in f)
                o[i] = n[f[i]];
            o.protocol && (o.protocol = o.protocol.toLowerCase()),
            o.hostname && (o.hostname = o.hostname.toLowerCase());
            var s = o.protocol;
            if (s && (o.slashes = -1 !== e.lastIndexOf(s + "//")),
            s && !r(s.slice(0, -1))) {
                if (!o.slashes)
                    return e = e.slice(0, s.length) + "//" + e.slice(s.length),
                    o = p.parse(e, t),
                    o.slashes = null,
                    o
            } else
                o.hostname && !o.pathname && (o.pathname = "/");
            return o.path = o.pathname,
            o.search && (o.path += o.search),
            o.host = o.hostname,
            o.port && (o.host = o.hostname + ":" + o.port),
            o.search && (o.query = o.search.substring(1)),
            t && o.query && (o.query = a.parse(o.query)),
            o.href = p.format(o),
            o
        },
        format: function(e, t) {
            var n = e.host;
            void 0 === n && e.hostname && (n = encodeURIComponent(e.hostname),
            e.port && (n += ":" + e.port));
            var o = e.search
              , s = e.query;
            void 0 === o && void 0 !== s && ("string" != typeof s && (s = a.stringify(s, void 0, void 0, t)),
            s && (o = "?" + s)),
            o && "?" !== o.charAt(0) && (o = "?" + o);
            var d = e.hash || "";
            d && "#" !== d.charAt(0) && (d = "#" + d);
            var f, p, h = e.pathname || "", v = [];
            return (f = e.protocol) && (":" !== f.slice(-1) && (f += ":"),
            v.push(i(f, l))),
            void 0 !== n && ((this.slashes || f && r(f)) && v.push("//"),
            (p = e.auth) && (v.push(i(p, l)),
            v.push("@")),
            v.push(n)),
            h && v.push(i(h, c)),
            o && v.push(o),
            d && v.push("#" + i(d.substring(1), u)),
            v.join("")
        },
        resolve: function(e, t) {
            ...
            for (var a = 0; a < o.length; a++) {
                ...
                "pathname" === l) {
                    var c = t.pathname;
                    c && (r = 1,
                    "/" !== c.charAt(0) && (i.hostname && !i.pathname ? c = "/" + c : i.pathname && ("/." !== c.slice(-2) && "/.." !== c.slice(-3) && "." !== c && ".." !== c || (c += "/"),
                    -1 !== (n = i.pathname.lastIndexOf("/")) && (c = i.pathname.slice(0, n + 1) + c))),
                    i.pathname = s.normalize(c))
                } else
                    "search" === l ? t.search && (i.search = t.search,
                    r = 1) : t[l] && (r = r || i[l] !== t[l],
                    i[l] = t[l])
            }
            return p.format(i)
      ...
      , i = {
        resolve: function() {
            ...
            for (t = a.length - 1; t >= 0 && !s; t--)
                "string" == typeof (o = a[t]) && o && (i = o + "/" + i,
                s = "/" === o.charAt(0));
            return e = r(n(i), !s).join("/"),
            (s ? "/" : "") + e || "."
        },
        normalize: function(e) {
            var t = "/" === e.charAt(0)
              , o = "/" === e.slice(-1);
            return (e = r(n(e), !t).join("/")) || t || (e = "."),
            e && o && (e += "/"),
            (t ? "/" : "") + e
        },
        join: function() {
        ...
        relative: function(e, t) {
            e = i.normalize(e),
            t = i.normalize(t);
            var r, o, a = n(e), s = [], l = n(t), c = Math.min(a.length, l.length);
        ...
        basename: function(e, t) {
            var n = (e.match(o) || [])[3] || "";
            return t && n && n.slice(-1 * t.length) === t && (n = n.slice(0, -1 * t.length)),
            n
        },
        dirname: function(e) {
            var t = e.match(o) || []
...
, function(e, t, n) {
    var r, o = n(84), i = n(88), a = n(89), s = window.document, l = {}, c = "undefined" != typeof KISSY ? KISSY.Config : {};
    e.exports = function(e, t, n) {
        function u() {
            var e = y.readyState;
            e && "loaded" !== e && "complete" !== e || (y.onreadystatechange = y.onload = null,
            _(0))
        }
        var d, f, p, h, v, m = t, g = 0;
        if (i.startsWith(o.extname(e).toLowerCase(), ".css") && (g = 1),
        "object" == typeof m && (t = m.success,
        d = m.error,
        f = m.timeout,
        n = m.charset,
        p = m.attrs),
        ...
        n && (y.charset = n),
        g ? (y.href = e,
        y.rel = "stylesheet") : (y.src = e,
        y.async = !0),
        h.node = y;
        var _ = function(t) {
            var n, r = t;
            b(),
            i.each(l[e], function(e) {
                (n = e[r]) && n.call(y)
            }),
            delete l[e]
        }
        ...
        r || (r = a.docHead()),
        g ? r.appendChild(y) : r.insertBefore(y, r.firstChild),
        y
    }
}
, function(e, t) {
    ...
    var r, o = (window.navigator || {}).userAgent || "", i = {}, a = Array.isArray || function(e) {
...
, function(e, t, n) {
    ...
    function i(e, t) {
        var n = 0;
        if (s.webkit)
            e.sheet && (o("webkit css poll loaded: " + t),
            n = 1);
        else if (e.sheet)
            try {
                e.sheet.cssRules && (o("same domain css poll loaded: " + t),
                n = 1)
            } catch (e) {
                var r = e.name;
                o("css poll exception: " + r + " " + e.code + " " + t),
                "NS_ERROR_DOM_SECURITY_ERR" === r && (o("css poll exception: " + r + "loaded : " + t),
                n = 1)
            }
        return n
    }
    function a() {
        for (var e in u) {
            var t = u[e]
              , n = t.node;
            i(n, e) && (t.callback && t.callback.call(n),
            delete u[e])
        }
        s.isEmptyObject(u) ? (o("clear css poll timer"),
        c = 0) : c = setTimeout(a, l)
    }
    var s = n(88)
      , l = 30
      , c = 0
...
, function(e, t) {
    ...
    o.ieMode = document.documentMode || o.ie),
    e.exports = o
}
, function(e, t, n) {
    function r(e) {
    ...
    function o(e) {
        ...
        return o.io = e,
        n && !s.supportCORS && r(t.uri.hostname) && !1 !== a.proxy ? new l(e) : (o.nativeXhr = s.nativeXhr(n),
        o)
    }
    var i = n(67)
      , a = n(66)
...
, function(e, t, n) {
    ...
    function a(e) {
        var t;
        return e.ifModified && (t = e.uri,
        !1 === e.cache && delete (t = l.clone(t)).query._ksTS,
        t = c.stringify(t)),
        t
    }
    var s, l = n(67), c = n(82), u = n(75), d = n(66), f = n(91), p = window, h = f.ieMode > 7 && p.XDomainRequest, v = {
        proto: {}
    }, m = {}, g = {};
    d.__lastModifiedCached = m,
    d.__eTagCached = g,
    v.nativeXhr = p.ActiveXObject ? function(e, t) {
        return !s && e && h ? new h : !d.isLocal && r(0, t) || o(0, t)
    }
    : r,
    s = v.supportCORS = "withCredentials"in v.nativeXhr(),
    v.XDomainRequest_ = h,
    l.mix(v.proto, {
        sendInternal: function() {
            var e, t, n, r, o = this, c = o.io, d = c.config, f = o.nativeXhr, p = d.files, h = p ? "post" : d.type, v = d.async, y = c.mimeType, b = c.requestHeaders || {}, _ = c._getUrlForSend(), w = a(d);
            w && ((n = m[w]) && (b["If-Modified-Since"] = n),
            (n = g[w]) && (b["If-None-Match"] = n)),
            (e = d.username) ? f.open(h, _, v, e, d.password) : f.open(h, _, v),
            "withCredentials"in (t = d.xhrFields || {}) && (s || delete t.withCredentials);
            for (r in t)
                try {
                    f[r] = t[r]
                } catch (e) {}
            if (y && f.overrideMimeType && f.overrideMimeType(y),
            !1 === b["X-Requested-With"] && delete b["X-Requested-With"],
            void 0 !== f.setRequestHeader)
                for (r in b)
            ...
            f.send(E),
            v && 4 !== f.readyState ? i(f) ? (f.onload = function() {
                f.readyState = 4,
                f.status = 200,
                o._callback()
            }
        ...
        _callback: function(e, t) {
            var n, r, o, s, c, u = this, f = u.nativeXhr, p = u.io, h = p.config;
            try {
                if (t || 4 === f.readyState)
                    if (i(f) ? (f.onerror = l.noop,
                    f.onload = l.noop) : f.onreadystatechange = l.noop,
                    t)
                        4 !== f.readyState && f.abort();
                    else {
                        n = a(h);
                        var v = f.status;
                        i(f) || (p.responseHeadersString = f.getAllResponseHeaders()),
                        n && (r = f.getResponseHeader("Last-Modified"),
                        o = f.getResponseHeader("ETag"),
                        r && (m[n] = r),
                        o && (g[o] = o)),
                        (c = f.responseXML) && c.documentElement && (p.responseXML = c);
                        var y = p.responseText = f.responseText;
                        if (h.files && y) {
                            var b, _;
                            -1 !== (b = y.indexOf("<body>")) && (-1 === (_ = y.lastIndexOf("</body>")) && (_ = y.length),
                            y = y.slice(b + 6, _)),
                            p.responseText = l.unEscapeHtml ? l.unEscapeHtml(y) : y
                        }
                        try {
                            s = f.statusText
                        } catch (e) {
                        ...
                        v || !d.isLocal || h.crossDomain ? 1223 === v && (v = 204) : v = p.responseText ? 200 : 404,
                        p._ioReady(v, s)
                    }
            } catch (e) {
                console.error(e.stack || e),
                ...
                f.onreadystatechange = l.noop,
                t || p._ioReady(-1, e.message || "process error")
            }
        }
    }),
    e.exports = v
...
, function(e, t, n) {
    ...
    function o() {
        var e = this
          ...
          , n = d[t];
        n.ready = 1,
        a.removeEvent(n.iframe, "load", e._onLoad),
        e.send()
    }
    var i = n(67)
      , a = n(91)
    ...
    i.augment(r, c.proto, {
        send: function() {
            var e, t, n = this, r = n.io.config, o = r.uri, i = o.hostname, f = d[i], p = "/sub_domain_proxy.html";
            if (r.xdr && r.xdr.subDomain && r.xdr.subDomain.proxy && (p = r.xdr.subDomain.proxy),
            f && f.ready)
                return n.nativeXhr = c.nativeXhr(0, f.iframe.contentWindow),
                void (n.nativeXhr ? n.sendInternal() : console.error("io: document.domain not set correctly!"));
            f ? e = f.iframe : (e = (f = d[i] = {}).iframe = u.createElement("iframe"),
            l.css(e, {
                position: "absolute",
                left: "-9999px",
                top: "-9999px"
            }),
            l.prepend(e, u.body || u.documentElement),
            (t = {}).protocol = o.protocol,
            t.host = o.host,
            t.pathname = p,
            e.src = s.stringify(t)),
            a.addEvent(e, "load", n._onLoad)
        }
    }),
    e.exports = r
}
      ...
      , l = e.exports = {
        ...
        getWindow: function(e) {
            ...
            if (r.isWindow(e))
                return e;
            var t = e;
            return t.nodeType !== s.DOCUMENT_NODE && (t = e.ownerDocument),
            t.defaultView || t.parentWindow
        },
        getDocument: function(e) {
            return e ? (e = l.get(e),
            r.isWindow(e) ? e.document : e.nodeType === s.DOCUMENT_NODE ? e : e.ownerDocument) : i
        },
        ...
        nodeName: function(e) {
            var t = l.get(e)
              ...
              , r = t.scopeName;
            return r && "HTML" !== r && (n = r.toLowerCase() + ":" + n),
            n
        },
...
, function(e, t, n) {
    ...
    var i = n(67)
      ...
      , y = {
        ...
        set: function(e, t, n) {
            var r;
            return !1 === t ? a.removeAttr(e, n) : ((r = g[n] || n)in e && (e[r] = !0),
      ...
      , w = {
        select: {
            get: function(e) {
                var t, n, r, o = e.selectedIndex, i = e.options, s = "select-one" === String(e.type);
                if (o < 0)
                    return null;
                if (s)
                    return a.val(i[o]);
    ...
    i.each(["radio", "checkbox"], function(e) {
        w[e] = {
            ...
            set: function(e, t) {
                if (i.isArray(t))
                    return e.checked = i.inArray(a.val(e), t),
                    1
            }
        }
    }),
    ...
    i.mix(a, {
            ...
            if ("object" != typeof t) {
                ...
                void 0 === n) {
                    ...
                    for (i = d.length - 1; i >= 0; i--)
                        (p = d[i]) && p.nodeType === s.ELEMENT_NODE && ("form" === l(p) && (o = _),
                        o && o.set ? o.set(p, n, t) : p.setAttribute(t, "" + n))
            } else {
                r = n;
                for (var b in t)
                    a.attr(d, b, t[b], r)
        ...
        removeAttr: function(e, t) {
            t = t.toLowerCase(),
            t = h[t] || t;
            var n, r, o, i = a.query(e);
            for (o = i.length - 1; o >= 0; o--)
                (r = i[o]).nodeType === s.ELEMENT_NODE && (r.removeAttribute(t),
                c.test(t) && (n = g[t] || t)in r && (r[n] = !1))
        },
        val: function(e, t) {
            var n, o, s, c, u, d;
            if (void 0 !== t)
                for (u = (c = a.query(e)).length - 1; u >= 0; u--) {
                    if (1 !== (s = c[u]).nodeType)
                        return;
                    null == (d = t) ? d = "" : "number" == typeof d ? d += "" : i.isArray(d) && (d = i.map(d, r)),
                    (n = w[l(s)] || w[s.type]) && "set"in n && void 0 !== n.set(s, d, "value") || (s.value = d)
                }
            else if (s = a.get(e))
        ...
        text: function(e, t) {
            ...
            for (o = (r = a.query(e)).length - 1; o >= 0; o--)
                (i = (n = r[o]).nodeType) === s.ELEMENT_NODE ? (a.cleanData(n.getElementsByTagName("*")),
                "textContent"in n ? n.textContent = t : n.innerText = t) : i !== s.TEXT_NODE && i !== s.CDATA_SECTION_NODE || (n.nodeValue = t)
        },
        _getText: function(e) {
...
, function(e, t, n) {
    ...
    function o(e) {
        return function(t, n) {
            var r, o, i, a = t.classList, s = l.call(arguments, 2);
            for (r = 0,
            o = n.length; r < o; r++)
...
, function(e, t, n) {
    ...
    function o(e, t) {
        ...
        return t && n === y && (n.innerHTML = ""),
        n
    }
    function i(e, t) {
        var n = o(t);
        return n.innerHTML = "m<div>" + e + "</div>",
        n.lastChild
    }
    function a(e) {
        try {
    ...
    function s(e, t) {
        t && (x && t.canHaveChildren && "removeNode"in e ? (e.firstChild && a(e),
        e.removeNode(!1)) : t.removeChild(e))
    }
    function l(e, t, n) {
        var o = t.nodeType;
    ...
    function u(e, t) {
        var n = e.nodeType;
        return n === m.ELEMENT_NODE ? h.attr(e, t, !0) : n === m.DOCUMENT_FRAGMENT_NODE && h.attr(e.childNodes, t, !0),
        e
    }
    function d(e) {
        var t, n, r = null;
        ...
        for (r = e[0].ownerDocument.createDocumentFragment(),
        t = 0,
        n = (e = p.makeArray(e)).length; t < n; t++)
            r.appendChild(e[t]);
        return r
    }
    var f, p = n(67), h = n(97), v = document, m = h.NodeType, g = "div", y = v && v.createElement(g), b = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, _ = /<([\w:]+)/, w = /^\s+/, E = /\s+$/, x = function(e) {
        var t, n;
        return !(!(t = navigator.userAgent.match(/MSIE ([^;]*)|Trident.*; rv(?:\s|:)?([0-9.]+)/)) || !(n = t[1] || t[2])) && parseFloat(n) < 9
    }(), T = x, S = /<|&#?\w+;/, C = /^<(\w+)\s*\/?>(?:<\/\1>)?$/, O = h._creators = {
        div: i
    }, k = {
        area: "map",
        thead: "table",
    ...
    p.mix(h, {
        create: function(e, t, n, r) {
            ...
            void 0 === r && (r = !0),
            r && (e = p.trim(e));
            var a, s, l, c, f, m = n || v, y = g;
            if (S.test(e))
                if (l = C.exec(e))
                    o = m.createElement(l[1]);
                else if (e = e.replace(b, "<$1></$2>"),
                (l = _.exec(e)) && (c = l[1]) && (y = c.toLowerCase()),
                a = (O[y] || i)(e, m),
                T && (s = e.match(w)) && a.insertBefore(m.createTextNode(s[0]), a.firstChild),
                T && /\S/.test(e) && (s = e.match(E)) && a.appendChild(m.createTextNode(s[0])),
                1 === (f = a.childNodes).length)
        ...
        _fixCloneAttributes: function(e, t) {
            ...
            "textarea" === o ? (t.defaultValue = e.defaultValue,
            t.value = e.value) : "input" !== o || "checkbox" !== i && "radio" !== i || ((r = e.checked) && (t.defaultChecked = t.checked = r),
            n = e.value,
            t.value !== n && (t.value = n))
        },
        _defaultCreator: i,
        html: function(e, t, n) {
            var i, a, s, l = h.query(e), c = l[0], u = !1;
            if (c) {
                if (void 0 === t) {
                ...
                if (!((t += "").match(/<(?:script|style|link)/i) || T && t.match(w) || k[(t.match(_) || ["", ""])[1].toLowerCase()]))
                    try {
                        for (a = l.length - 1; a >= 0; a--)
                            (s = l[a]).nodeType === m.ELEMENT_NODE && (h.cleanData(r(s, "*")),
                            s.innerHTML = t);
                        u = !0
                    } catch (e) {}
                u || (i = h.create(t, 0, c.ownerDocument, 0),
                h.empty(l),
                h.append(i, l, n))
            }
        },
        remove: function(e, t, n) {
            var o, i, a, l = h.query(e);
            for (a = l.length - 1; a >= 0; a--)
                o = l[a],
                t || o.nodeType !== m.ELEMENT_NODE || ((i = p.makeArray(r(o, "*"))).push(o),
                h.removeData(i),
                n && n.detach(i)),
                s(o, o.parentNode)
        },
        clone: function(e, t, n, r, o) {
            "object" == typeof t && (r = t.deepWithDataAndEvent,
            n = t.withDataAndEvent,
            t = t.deep);
            var i, a, s = h.get(e), u = h._fixCloneAttributes;
            return s ? (a = s.nodeType,
            i = s.cloneNode(t),
            a !== m.ELEMENT_NODE && a !== m.DOCUMENT_FRAGMENT_NODE || (u && a === m.ELEMENT_NODE && u(s, i),
            t && u && l(u, s, i)),
            n && (c(s, i, o),
            t && r && l(c, s, i)),
            i) : null
    ...
    var r = n(67)
      ...
      , u = {
        ...
        removeData: function(e, t) {
            ...
            if (void 0 !== t)
                delete n[t],
                r.isEmptyObject(n) && u.removeData(e);
            else
                try {
                    delete e[a]
                } catch (t) {
      ...
      , d = {
        ...
        removeData: function(e, t) {
            ...
            if (n) {
                ...
                if (void 0 !== t)
                    delete o[t],
                    r.isEmptyObject(o) && d.removeData(e);
                else {
                    delete s[n];
                    try {
                        delete e[a]
...
, function(e, t, n) {
    ...
    function o(e, t) {
        ...
        for (n = 0; e[n]; n++)
            if (i = e[n],
            a = f(i),
            i.nodeType === u.DOCUMENT_FRAGMENT_NODE)
                ...
                if (i.nodeType === u.ELEMENT_NODE && !d.test(a)) {
                    var l, c, v = [], m = i.getElementsByTagName("script");
    ...
    function a(e, t, n, r) {
        ...
        r && (r = []),
        e = o(e, r),
        c._fixInsertionChecked && c._fixInsertionChecked(e),
        t = c.query(t);
        var a, l, u, d, f = e.length, p = t.length;
        if ((f || r && r.length) && p)
            for (a = c._nodeListToFragment(e),
            p > 1 && (d = c.clone(a, !0),
            t = s.makeArray(t)),
            l = 0; l < p; l++)
                u = t[l],
                a && n(l > 0 ? c.clone(d, !0) : a, u),
                r && r.length && s.each(r, i)
    }
    var s = n(67)
      , l = n(86)
      , c = n(97)
...
, function(e, t, n) {
    function r(e) {
        var t, n, r, o = e.ownerDocument.body;
        return e.getBoundingClientRect ? (t = e.getBoundingClientRect(),
        n = t[g],
        r = t[y],
        n -= f.clientLeft || o.clientLeft || 0,
        r -= f.clientTop || o.clientTop || 0,
        {
            left: n,
            top: r
        }) : {
    ...
    function i(e, t) {
        ...
        do {
            ...
            i.left += n.left,
            i.top += n.top
        } while (a && a != t && (s = a.frameElement) && (a = a.parent));return i
    }
    function a(e, t) {
        "static" === l.css(e, v) && (e.style[v] = m);
        var n, r, o = i(e), a = {};
        for (r in t)
            n = parseFloat(l.css(e, r)) || 0,
            a[r] = n + t[r] - o[r];
        l.css(e, a)
    }
    var s = n(67)
    ...
    s.each(["Left", "Top"], function(e, t) {
        ...
        l[n] = function(r, o) {
            ...
            var i, a, s, u, f;
            return (r = l.get(r)) && r.nodeType === d.ELEMENT_NODE ? void 0 !== o ? r[n] = parseFloat(o) : i = r[n] : (u = p(r),
            void 0 !== o ? (o = parseFloat(o),
            a = "Left" === e ? o : l.scrollLeft(u),
            s = "Top" === e ? o : l.scrollTop(u),
            u.scrollTo(a, s)) : "number" != typeof (i = u["page" + (t ? "Y" : "X") + "Offset"]) && "number" != typeof (i = (f = u.document).documentElement[n]) && (i = f.body[n])),
            i
        }
    }),
...
, function(e, t, n) {
    ...
    function o(e) {
        var t, n, r = I[e];
        return I[e] || (t = x.body || x.documentElement,
        n = x.createElement(e),
        m.prepend(n, t),
        r = m.css(n, "display"),
        t.removeChild(n),
    ...
    function a(e, t, n, o) {
        ...
        if (i = e.style) {
            ...
            t = r(t),
            void 0 === n)
                return s && "get"in s && void 0 !== (a = s.get(e, !1)) || (a = i[t]),
                void 0 === a ? "" : a;
            if (null === n || n === k ? n = k : isNaN(Number(n)) || O[t] || (n += M),
            s && s.set && (n = s.set(e, n)),
            void 0 !== n) {
                try {
                    i[t] = n
        ...
        for (i = 0; i < t.length; i++)
            if (o = t[i])
                for (a = 0; a < n.length; a++) {
                    ...
                    s += parseFloat(m._getComputedStyle(e, l, r)) || 0
                }
        return s
    }
    function c(e, t) {
    ...
    function u(e) {
        ...
        return n.defaultView && (t = n.defaultView.getComputedStyle(e, null)),
        t
    }
    function d(e, t, n) {
        if (h.isWindow(e))
        ...
        var r = t === S ? ["Left", "Right"] : ["Top", "Bottom"]
          ...
          , s = 0;
        (null == o || o <= 0) && (o = void 0,
        (null == (s = m._getComputedStyle(e, t, i)) || Number(s) < 0) && (s = e.style[t] || 0),
        s = parseFloat(s) || 0),
        void 0 === n && (n = a ? E : _);
        var d = void 0 !== o || a
          , f = o || s;
    ...
    function f(e) {
        ...
        return "fixed" === m.css(e, "position") ? n = e.getBoundingClientRect() : (t = p(e),
        n = m.offset(e),
        (r = m.offset(t)).top += parseFloat(m.css(t, "borderTopWidth")) || 0,
        r.left += parseFloat(m.css(t, "borderLeftWidth")) || 0),
    ...
    h.mix(m, {
        ...
        _getComputedStyle: function(e, t, n) {
            var o, i, a, s, l = "", c = e.ownerDocument;
            return t = r(t),
            (n = n || c.defaultView.getComputedStyle(e, null)) && (l = n.getPropertyValue(t) || n[t]),
            "" !== l || m.contains(c, e) || (l = e.style[t]),
            m._RE_NUM_NO_PX.test(l) && T.test(t) && (o = (s = e.style).width,
            i = s.minWidth,
            a = s.maxWidth,
        ...
        _style: a,
        css: function(e, t, n) {
            var r, o, i, s, l = m.query(e), c = l[0];
            if ("object" != typeof t) {
                if (t = R(t),
                o = L[t],
                void 0 === n)
                    return i = "",
                    c && (o && "get"in o && void 0 !== (i = o.get(c, !0)) || (i = m._getComputedStyle(c, t))),
                    void 0 === i ? "" : i;
        ...
        show: function(e) {
            var t, n, r, i = m.query(e);
            for (r = i.length - 1; r >= 0; r--)
                (n = i[r]).style.display = m.data(n, C) || k,
                "none" === m.css(n, "display") && (t = o(n.tagName.toLowerCase()),
                m.data(n, C, t),
                n.style.display = t)
        },
        hide: function(e) {
        ...
        toggle: function(e) {
            ...
            for (n = r.length - 1; n >= 0; n--)
                t = r[n],
                "none" === m.css(t, "display") ? m.show(t) : m.hide(t)
        },
        addStyleSheet: function(e, t, n) {
            "string" == typeof e && (n = t,
            t = e,
            e = g);
            var r, o = m.getDocument(e);
            n && (n = n.replace("#", k)) && (r = m.get("#" + n, o)),
            r || (r = m.create("<style>", {
                id: n
            }, o),
            m.get("head", o).appendChild(r),
    ...
    h.each([S, "height"], function(e) {
        ...
        m[e] = function(n, r) {
            ...
            if (o) {
                var i = u(o);
                return c(o, i) && (r += l(o, ["padding", "border"], t, i)),
                m.css(n, e, r)
            }
        }
        ,
...
, function(e, t) {
    ...
    var o, i, a, s, l = window, c = ["Webkit", "Moz", "O", "ms"], u = c.length, d = l.document || {}, f = d && d.documentElement, p = !0, h = !1, v = "ontouchstart"in d && !window.callPhantom, m = {}, g = d.documentMode;
    f && (f.querySelector && 8 !== g && (h = !0),
    i = f.style,
    p = "classList"in f,
    o = "msPointerEnabled"in navigator,
...
, function(e, t, n) {
    ...
    function u(e, t) {
        var n, o, a, s, l = "string" == typeof e, d = void 0 !== t ? u(t) : (s = 1) && [y], f = d.length;
        if (e) {
            if (l) {
                if (e = N(e),
                s)
            ...
            } else if (n = e.nodeType || m.isWindow(e) ? [e] : e.getDOMNodes ? e.getDOMNodes() : E(e) ? e : T(e) ? x(e) : [e],
            !s) {
                var R, P = n, j = P.length;
                for (n = [],
                o = 0; o < j; o++)
                    for (R = 0; R < f; R++)
    ...
    var h, v = n(97), m = n(67), g = n(108), y = document, b = y.documentElement, _ = b.matches || b.webkitMatchesSelector || b.mozMatchesSelector || b.oMatchesSelector || b.msMatchesSelector, w = "getElementsByClassName"in y, E = m.isArray, x = m.makeArray, T = v.isDomNodeList, S = " ", C = Array.prototype.push, O = /^\.([\w-]+)$/, k = /^#([\w-]+)$/, M = /^([\w-])+$/, A = /^([\w-]+)#([\w-]+)$/, L = /^(?:#([\w-]+))?\s*([\w-]+|\*)?\.?([\w-]+)?$/, N = m.trim;
    h = w ? function(e, t) {
    ...
    ;
    var I = "sourceIndex"in b ? function(e, t) {
    ...
    m.mix(v, {
        ...
        filter: function(e, t, n) {
            var r, o, i, a, s = u(e, n);
            return "string" == typeof t && (t = N(t)) && (i = L.exec(t)) && (r = i[1],
            o = i[2],
            a = i[3],
            r ? !r || o || a || (t = function(e) {
                return f(e, "id") === r
            }
            ) : t = function(e) {
                var t = !0
...
, function(e, t, n) {
    function r(e, t, n, r, i, c, u) {
        ...
        i = i && s.get(i) || null,
        void 0 === t && (t = 1);
        var d, f, p = [], h = a.isArray(t);
        for ("number" == typeof t && (d = 0,
        f = t,
        t = function() {
            return ++d === f
        }
        ); e && e !== i && (!(e.nodeType === l.ELEMENT_NODE || e.nodeType === l.TEXT_NODE && u) || !o(e, t) || r && !r(e) || (p.push(e),
        h)); )
            e = e[n];
        return h ? p : p[0] || null
    }
    ...
    function i(e, t, n, r) {
        var o, i, c, u = [], d = s.get(e), f = d;
        if (d && n && (f = d.parentNode),
        f) {
            for (o = a.makeArray(f.childNodes),
            i = 0; i < o.length; i++)
                c = o[i],
                (r || c.nodeType === l.ELEMENT_NODE) && c !== d && u.push(c);
            t && (u = s.filter(u, t))
        }
        return u
    }
    ...
    a.mix(s, {
        ...
        index: function(e, t) {
            ...
            return r = s.query(t),
            "string" == typeof t ? a.indexOf(c, r) : a.indexOf(r[0], o)
        },
        equals: function(e, t) {
            if (e = s.query(e),
            t = s.query(t),
...
, function(e, t, n) {
    function r(e) {
        var t = this;
        return e.config.crossDomain ? (t.io = e,
        t) : new (i.getTransport("*"))(e)
    }
    var o = n(67)
      , i = n(66);
    i.setupConfig({
    ...
    o.augment(r, {
        ...
        _callback: function(e, t) {
            var n = this
              ...
              , o = n.io;
            r && (n.script = void 0,
            t || ("error" !== e ? o._ioReady(200, "success") : "error" === e && o._ioReady(500, "script error")))
        },
        abort: function() {
            this._callback(0, 1)
        }
...
, function(e, t, n) {
    ...
    o.addPreprocessor("start", function(e) {
        ...
        if ("jsonp" === o[0]) {
            ...
            var a, s, l = n.jsonpCallback, c = "function" == typeof l ? l() : l, u = i[c];
            n.uri.query[n.jsonp] = c,
            i[c] = function(e) {
                arguments.length > 1 && (e = r.makeArray(arguments)),
                a = [e]
            }
            ,
            t.fin(function() {
            ...
            (s = n.converters).script = s.script || {},
            s.script.json = function() {
                if (!a)
...
, function(e, t, n) {
    function r(e) {
        var t, n, r, i = e.responseText, a = e.responseXML, s = e.config, l = s.converters, c = s.contents, u = s.dataType;
        if (i || a) {
    ...
    o.extend(a, i, {
        ...
        overrideMimeType: function(e) {
            var t = this;
            return t.state || (t.mimeType = e),
            t
        },
        abort: function(e) {
            var t = this;
            return e = e || "abort",
            t.transport && t.transport.abort(e),
            t._ioReady(0, e),
            t
        },
                ...
                if (e >= 200 && e < 300 || 304 === e)
                    if (304 === e)
                        ...
                        try {
                            ...
                            t = e.message || "parser error"
                        }
                else
                    e < 0 && (e = 0);
                n.status = e,
                n.statusText = t;
                var i, s = n.defer, l = n.config;
                (i = n.timeoutTimer) && (clearTimeout(i),
                n.timeoutTimer = 0);
                var c, u = o ? "success" : "error", d = [n.responseData, t, n], f = l.context, p = {
                    io: n
                };
                (c = l[u]) && c.apply(f, d),
                (c = l.complete) && c.apply(f, d),
                a.fire(u, p),
                a.fire("complete", p),
                s[o ? "resolve" : "reject"](d)
            }
        },
        _getUrlForSend: function() {
            var e = this.config
              , t = e.uri
              , n = t.search || "";
            return delete t.search,
            n && !o.isEmptyObject(t.query) && (n = "&" + n.substring(1)),
            s.stringify(t, e.serializeArray) + n
        }
    })
}
, function(e, t, n) {
    function r(e) {
        var t, n = l.guid("io-iframe"), r = u.getEmptyIframeSrc();
        return t = e.iframe = u.create("<iframe " + (r ? ' src="' + r + '" ' : "") + ' id="' + n + '" name="' + n + '" style="position:absolute;left:-9999px;top:-9999px;"/>'),
        u.prepend(t, p.body || p.documentElement),
        t
    }
    function o(e, t, n) {
        var r, o, i, a = [];
        return l.each(e, function(e, s) {
            for ((r = l.isArray(e)) || (e = [e]),
            o = 0; o < e.length; o++)
                (i = p.createElement("input")).type = "hidden",
                i.name = s + (r && n ? "[]" : ""),
                i.value = e[o],
                u.append(i, t),
                a.push(i)
    ...
    function a(e) {
        var t, n = this, r = n.form, o = n.io, a = e.type, s = o.iframe;
        if (s)
            if ("abort" === a && 6 === f.ie ? setTimeout(function() {
                u.attr(r, n.attrs)
            }, 0) : u.attr(r, n.attrs),
            i(this.fields),
            f.removeEvent(s, "load", n._callback),
            f.removeEvent(s, "error", n._callback),
            setTimeout(function() {
                u.remove(s)
            }, m),
            o.iframe = null,
            "load" === a)
                try {
                    (t = s.contentWindow.document) && t.body && (o.responseText = u.html(t.body),
                    l.startsWith(o.responseText, "<?xml") && (o.responseText = void 0)),
                    t && t.XMLDocument ? o.responseXML = t.XMLDocument : o.responseXML = t,
                    t ? o._ioReady(h, "success") : o._ioReady(v, "parser error")
                } catch (e) {
    ...
    l.augment(s, {
        send: function() {
            function e() {
                f.addEvent(n, "load", a._callback),
                f.addEvent(n, "error", a._callback),
                p.submit()
            }
            var t, n, i, a = this, s = a.io, l = s.config, d = l.data, p = u.get(l.form);
            a.attrs = {
            ...
            d && (i = c.parse(d)),
            i && (t = o(i, p, l.serializeArray)),
            a.fields = t,
            6 === f.ie ? setTimeout(e, 0) : e()
        },
        abort: function() {
            this._callback({
                type: "abort"
...
, function(e, t, n) {
    ...
    i.mix(i, {
        escapeHtml: function(e) {
            return e || 0 === e ? (e = "" + e,
            c.test(e) ? (e + "").replace(r, function(e) {
                return l[e]
            }) : e) : ""
        },
    ...
    i.escapeHTML = i.escapeHtml,
    i.unEscapeHTML = i.unEscapeHtml
}
, function(e, t, n) {
    var r = n(67);
    r.mix(r, {
...
, function(e, t, n) {
    (function(e) {
        ...
        var i, a = n(67), s = "undefined" == typeof window ? e : window, l = "__~ks_compared";
        !function(e, t) {
            for (var n in t)
                e[n] = t[n]
        }(a, {
    ...
    r.mix(r, {
        parseXml: function(e) {
            if (e.documentElement)
                return e;
            var t;
            if (o.DOMParser ? t = (new DOMParser).parseFromString(e, "text/xml") : ((t = new ActiveXObject("Microsoft.XMLDOM")).async = !1,
            t.loadXML(e)),
    ...
    !function(t, n) {
        ...
        function r(e) {
            if (!d) {
                var t = function() {}
                  , n = e.$watch(t, t);
                d = e._watchers[0].constructor,
                n()
            }
            return d
        }
        function o(e) {
            return f || (f = e._data.__ob__.dep.constructor),
            f
        }
        function i(e) {
            p && (p.emit("vuex:init", e),
            p.on("vuex:travel-to-state", function(t) {
                e.replaceState(t)
            }),
        ...
        : function(e) {
          ...
          , h = function(e) {
            function t() {
                var e = this.$options
                  , t = e.store
                  , n = e.vuex;
                if (t ? this.$store = t : e.parent && e.parent.$store && (this.$store = e.parent.$store),
                n) {
                    this.$store || console.warn("[vuex] store not injected. make sure to provide the store option in your root component.");
                    var r = n.state
                      , o = n.actions
                      , a = n.getters;
                    if (r && !a && (console.warn("[vuex] vuex.state option will been deprecated in 1.0. Use vuex.getters instead."),
                    a = r),
                    a) {
            ...
            function s(e, t, n) {
                return "function" != typeof t && console.warn("[vuex] Action bound to key 'vuex.actions." + n + "' is not a function."),
                function() {
          ...
          , g = function() {
            function o() {
                ...
                v.config.silent = y,
                this._setupModuleState(r, u),
                this._setupModuleMutations(u),
                h && this._setupMutationCheck(),
                i(this),
            ...
            return c(o, [{
                ...
                value: function(e) {
                    ...
                    var i = !1
                      , a = !1;
                    "object" === (void 0 === e ? "undefined" : s(e)) && e.type && 1 === arguments.length && (a = !0,
                    r = e,
                    e.silent && (i = !0),
                    e = e.type);
                    var l = this._mutations[e]
                      , c = this.state;
                    l ? (this._dispatching = !0,
                    Array.isArray(l) ? l.forEach(function(e) {
                        a ? e(c, r) : e.apply(void 0, [c].concat(u(r)))
                    }) : a ? l(c, r) : l.apply(void 0, [c].concat(u(r))),
                    this._dispatching = !1,
                    i || function() {
                        var n = a ? r : {
                            type: e,
                ...
                value: function() {
                    var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}
                      , t = e.mutations
                      , n = e.modules;
                    this._rootMutations = this._mutations = t || this._rootMutations,
                ...
                value: function(e, n) {
                    ...
                    t(n) && Object.keys(n).forEach(function(t) {
                        var o = n[t];
                        v.set(e, t, o.state || {}),
                        r._setupModuleState(e[t], o.modules)
                    })
                }
            }, {
...
, function(e, t) {
    ...
    var n = {
        ...
        ITEM_MERGE: function(e) {
            e.newShare = !1,
            e.cacheItemList.reverse(),
            e.itemList = e.cacheItemList.concat(e.itemList),
            e.cacheItemList.length = 0
        },
      ...
      , s = {
        ...
        followPub: function(e, t) {
            var n = e.dispatch
              , r = (e.state,
            this);
            if (goldlog && goldlog.record("/taobaolive.pclive.remind", "CLK", "", "H1481495473"),
            o.default.strBoolean(r.video.broadCaster.isFollow)) {
    ...
    var s = function() {
            ...
            return new Promise(function(o, i) {
                ...
                0 === g)
                    ...
                    (h = new l.default.PowerMsg({
                        ...
                        g = 2,
                        h.subscribe();
                        p || (p = f.default.init(!0)),
                        n.__addEventListener(e);
                        for (var t in v)
                            !function(e) {
                                v[e]().then(function(t) {
                                    m[e] && m[e].resolve(t),
      ...
      , b = function(e) {
        function t(e) {
            ...
            return n.debug = e.debug,
            n.appkey = e.appkey,
            n.topic = e.topic,
            n.bizTag = e.bizTag,
            n.bizCode = e.bizCode,
            n.interval = e.interval || 3e3,
            n.accsToken = e.accsToken,
            n.userId = e.userId ? e.userId.toString() : "",
            n.nick = e.nick,
            n.aserverProxy = e.aserverProxy || "",
            y.__invoke(n),
            n
        }
    ...
    var i = function() {
        ...
        __addEventListener: function(e) {
            ...
            var n = function(n) {
                ...
                if (a === c.default.SUBTYPE.SYS_SUBTYPE.MTK_MSG_SYS_COMMON) {
                    ...
                    s.userId = o.getUserId(),
                    s.from = i.getFrom(),
                    s.timestamp = i.getTimestamp().toNumber(),
                    r ? e.emit("hisMessage", {
                        data: s
                    }) : e.emit("message", {
                        data: s
      ...
      , h = function() {
        function e(t) {
            ...
            this.interval = t.interval || 3e3,
            this.msgkit.on("ready", function(e) {
                n.emit("ready", e)
            }),
    ...
    r(n(146)))
      ...
      , I = {
            ...
            A || "ws" != e.mode ? k.require(["polyfill", "Long", "ByteBuffer", "ProtoBuf"], function(n, r, o, i) {
                ...
                t.__fetchConfList(function(n) {
                    ...
                    l.default.init({
                        ...
                        w.default.init(),
                        t.__initManager(e),
                        e.mode = n.MONITOR_RANGE_DOWNGRADE ? "mtop" : "ws"
                    }).catch(function(n) {
                        t.tryCount-- >= 0 ? (A = null,
                        t.__connect(e)) : e.mode = "mtop"
                    })
                })
            })
        },
        ...
        __createMtopFetch: function(e) {
            if (!this.stop) {
                ...
                e.msgManager.sendMsgByMtop(p.default.powermsg, n).then(function(n) {
                    for (var r = new Date((new Date).getTime() - t).getSeconds(), o = n.data, i = o.timestampList.length, a = (o.offset,
                    Number(o.period) || 2), s = null, l = 0; l < i; l++)
                        s = f.default.binaryStringToBinaryArray(window.atob(o.timestampList[l].data.replace(/[\s]/g, ""))),
                        e.msgManager.fireEventCallBack(s);
                    o.timestampList[i - 1] && o.timestampList[i - 1].offset,
        ...
        __initManager: function(e) {
            ...
            this.__addEventListener(e),
            e.emitter = new d.default,
            c.default.isLogin(function(n, r) {
                e.msg = new m.default({
        ...
        __addEventListener: function(e) {
            ...
            e.msgManager.onMessage("ACK", function(t) {
                var n = t.protocolData
                  ...
                  , o = n.msgType;
                if (n.msgHeader = r,
                o === h.default.MSG_TYPE.MKT_PROTOCOL_MSGTYPE_SUBACK)
                    try {
                        var i = w.default.decodeMsgBody(n.msgBodyBuffer);
                        n.msgBody = i,
                        null != n.msgBody.bizTag && n.msgBody.bizTag !== e.bizTag ? C.default.emit("ack", {
                    ...
                    o === h.default.MSG_TYPE.MKT_PROTOCOL_MSGTYPE_PUBACK ? (logs("%c [reqMessage event emit]", "color: #5ee81f;"),
                    e.emit("reqMessage", n)) : C.default.emit("ack", {
            ...
            e.msgManager.onMessage("INFO", function(t) {
                ...
                try {
                    ...
                    n.msgBody = r,
                    null != n.msgBody.sendTags && "" != n.msgBody.sendTags.join("") && -1 === n.msgBody.sendTags.indexOf(e.bizTag) && C.default.emit("ack", {
                        errorCode: O.SEND_ERR,
                        type: "SEND_ERR",
                        msg: "消息投递错误",
                        context: e,
                    ...
                    r.timestamp < M ? (logs("%c [hisInfoMessage event emit]", "color: #5ee81f;"),
                    e.emit("hisInfoMessage", n)) : (logs("%c [infoMessage event emit]", "color: #5ee81f;"),
                    e.emit("infoMessage", n)),
                    C.default.emit("ack", {
                        errorCode: O.SEND_SUCCESS,
                        type: "SEND_SUCCESS",
                        msg: "消息投递成功",
            ...
            e.msgManager.onMessage("CMD", function(t) {
                ...
                try {
                    ...
                    n.msgBody = r,
                    logs("%c [cmdMessage event emit]", "color: #5ee81f;"),
                    e.emit("cmdMessage", n)
                } catch (t) {
                    console.error(t),
                    C.default.emit("ack", {
      ...
      , R = function(e) {
        function t() {
            ...
            return void 0 === e.bizCode && console.error("bizCode为必填"),
            e.appkey || (r.indexOf("taobao.net") > -1 || r.indexOf("waptest.taobao.com") > -1 ? e.appkey = "4272" : e.appkey = "H5_4282"),
            n.appkey = e.appkey,
            n.accsToken = e.accsToken || "",
            n.aserverProxy = e.aserverProxy || "",
            n.topic = e.topic,
            ...
            n.bizTag = e.bizTag || "",
            n.interval = e.interval || 3e3,
            n.autoUnSub = e.autoUnSub,
            n.userId = e.userId || e.userId + "",
            n.nick = e.nick || lib.login.getUserNick(),
            e.mode ? n.mode = e.mode : window.WebSocket ? n.mode = "ws" : n.mode = "mtop",
            I.__connect(n),
            n
        }
        return a(t, d.default),
        s(t, [{
            key: "subscribe",
            value: function() {
                var e = this;
                this.hasBindUnSub || 1 != this.autoUnSub || (this.hasBindUnSub = !0,
                document.addEventListener("visibilitychange", function(t) {
                    return I.__autoUnSubFn(e, t)
                }));
                var t = this.topic
                  , n = this.msg;
                ...
                if (r.msgBodyBuffer = u.toArrayBuffer(),
                "ws" == this.mode)
            ...
            value: function(e, t, n) {
                ...
                return new Promise(function(s, l) {
                    if (lib.login.isLogin() || o.userId) {
                        ...
                        v.type = h.default.TYPE.MKT_MSG_TYPE_INFO,
                        v.Qos = h.default.QOS.MKT_MSG_QOS_RELIABLE;
                        var m = _.default.setMsgBody(t, n, i, a);
                        if (v.msgBodyBuffer = m.toArrayBuffer(),
                        v.msgDataBuffer = u.default.strToBuf(r),
                        "ws" == o.mode)
            ...
            value: function(e, t, n) {
                ...
                return new Promise(function(i, a) {
                    ...
                    c.type = h.default.TYPE.MKT_MSG_TYPE_REQUEST,
                    c.Qos = h.default.QOS.MKT_MSG_QOS_RELIABLE;
                    var d = y.default.setMsgBody(t, n);
                    if (c.msgBodyBuffer = d.toArrayBuffer(),
                    c.msgDataBuffer = u.default.strToBuf(o),
                    "ws" == r.mode)
            ...
            value: function(e, t, n, r, o) {
                ...
                return new Promise(function(s, l) {
                    if (lib.login.isLogin() && i.userId) {
                        ...
                        f.type = h.default.TYPE.MKT_MSG_TYPE_COMMAND,
                        f.Qos = h.default.QOS.MKT_MSG_QOS_RELIABLE;
                        var p = b.default.setMsgBody(t, n, r, o);
                        f.msgBodyBuffer = p.toArrayBuffer(),
                        f.msgDataBuffer = u.default.strToBuf(a),
                        "ws" == i.mode ? i.msgManager.sendCommandMsg(f).then(function(e) {
                            s(e)
                        }) : l({
                            errMsg: "未知的mode类型",
                            mode: i.mode
            ...
            value: function(e, t) {
                ...
                return new Promise(function(o, i) {
                    ...
                    l.type = h.default.TYPE.MKT_MSG_TYPE_COUNT,
                    l.Qos = h.default.QOS.MKT_MSG_QOS_RELIABLE;
                    var c = void 0;
                    for (var d in t)
                        c = g.default.setMsgBody(d, t[d]);
                    if (c && (l.msgBodyBuffer = c.toArrayBuffer()),
                    l.msgDataBuffer = u.default.strToBuf(r),
                    "ws" == n.mode)
...
, function(e, t, n) {
    ...
    var i = r(n(134))
      ...
      , u = function() {
        ...
        return t = t.toString().substr(0, 11),
        t += new Array(11 - t.length).join("0"),
        u = t + "_" + e
    }()
    ...
    var o = function() {
      ...
      , s = function() {
        function e(t, n) {
            ...
            r(this, e),
            this._subscribeMap = i.default.subscribeMap,
            this._ackMap = i.default.ackMap;
            ...
            var h = "";
            h = o ? p + "//" + o + ":" + c + "/accs/auth?token=" + s : p + "//acs." + d + ".taobao.com:" + c + "/accs/auth?token=" + s,
            this._initConnection(h, function(e) {
                e.isSuccess ? (l._connection = e.connection,
                l._bindEventHandler(),
                t(l)) : n({
        ...
        return o(e, [{
            ...
            value: function() {
                ...
                this._connection.onerror = function(t) {
                    console.log("accs_onerror", t),
                    e.onError && e.onError(t)
                }
                ,
                this._connection.onclose = function(t) {
                    console.log("accs_onclose", t),
            ...
            value: function(e, t) {
                ...
                return new Promise(function(r, o) {
                    try {
                        ...
                        r && (n._ackMap["_" + a.dataId] = r),
                        n._connection.send(JSON.stringify(a))
                    } catch (e) {
                        o(e)
                    }
                }
    ...
    (function(e) {
        ...
        var u = function() {
            function t() {
                ...
                r(this, t),
                this.moduleList = e.moduleList,
                this.callback = e.callback || new Function,
                this.instanceMap = {
                    length: 0
                },
                this._id = e.id,
            ...
            return o(t, [{
                ...
                value: function() {
                    for (var t = this, n = this.moduleList, r = n.length, o = 0; o < r && "break" !== function(r) {
                        var o = n[r];
                        if ("done" === s[o])
                            return t.instanceMap[o] = e[o] || dcodeIO[o] || e,
                            t.instanceMap.length++,
                            "break";
                        c.on(o + "Loaded", function(e) {
                            t.instanceMap[o] || (t.instanceMap[o] = e,
                            t.instanceMap.length++),
                            t.tryInvoke()
                        })
                    }(o); o++)
                ...
                value: function() {
                    ...
                    if (this.instanceMap.length === t.length && this.callback) {
                        ...
                        this.callback.apply(d, n),
                        this.callback = null,
                        c.emit("desctroy", this._id)
                    }
                }
            }]),
            t
          ...
          , d = {
            ...
            require: function(t, n) {
                ...
                for (var f = 0; f < r; f++) {
                    ...
                    -1 === p.indexOf(".js") ? t[f] = "" + this.config.filePath + p + ".js" : t[f] = "" + this.config.filePath + p,
                    "done" !== s[p] && "loading" !== s[p] ? s[p] = "loading" : t[f] = ""
                }
                if ((t = t.filter(function(e) {
                    ...
                    h.onload = function() {
                        ...
                        for (var t = o.length, n = 0; n < t; n++) {
                            var r = o[n];
                            s[r] = "done",
                            c.emit(r + "Loaded", e[r] || dcodeIO[r] || e)
                        }
                    }
                    ,
        ...
        t.default = {
            init: function() {
                var e = arguments.length <= 0 || void 0 === arguments[0] ? {} : arguments[0];
                return d.config.basePath = "//g.alicdn.com/mtb/lib-msg-runtime/1.0.0/??",
                d.config.filePath = e.filePath || "",
                d
            }
        }
    }
...
, function(e, t, n) {
    ...
    !function(i, a, s) {
        ...
        return e.prototype = {
            get: function() {
                var e = [];
                return e.push(navigator.userAgent),
            ...
            murmurhash3_32_gc: function(e, t) {
                ...
                c = 0; c < r; )
                    ...
                    ++c,
                    o = 27492 + (65535 & (i = 5 * (65535 & (o = (o ^= l = (65535 & (l = (l = (65535 & l) * a + (((l >>> 16) * a & 65535) << 16) & 4294967295) << 15 | l >>> 17)) * s + (((l >>> 16) * s & 65535) << 16) & 4294967295) << 13 | o >>> 19)) + ((5 * (o >>> 16) & 65535) << 16) & 4294967295)) + ((58964 + (i >>> 16) & 65535) << 16);
                switch (l = 0,
                n) {
                case 3:
    ...
    function(e, t) {
        ...
        function s(e) {
            ...
            f = 0; f < w.length; f += 16)
                ...
                v = b,
                m = _,
                g = s(g, y, b, _, w[f + 0], 7, 3614090360),
                _ = s(_, g, y, b, w[f + 1], 12, 3905402710),
                b = s(b, _, g, y, w[f + 2], 17, 606105819),
                y = s(y, b, _, g, w[f + 3], 22, 3250441966),
                g = s(g, y, b, _, w[f + 4], 7, 4118548399),
                _ = s(_, g, y, b, w[f + 5], 12, 1200080426),
                b = s(b, _, g, y, w[f + 6], 17, 2821735955),
                y = s(y, b, _, g, w[f + 7], 22, 4249261313),
                g = s(g, y, b, _, w[f + 8], 7, 1770035416),
                _ = s(_, g, y, b, w[f + 9], 12, 2336552879),
                b = s(b, _, g, y, w[f + 10], 17, 4294925233),
                y = s(y, b, _, g, w[f + 11], 22, 2304563134),
                g = s(g, y, b, _, w[f + 12], 7, 1804603682),
                _ = s(_, g, y, b, w[f + 13], 12, 4254626195),
                b = s(b, _, g, y, w[f + 14], 17, 2792965006),
                y = s(y, b, _, g, w[f + 15], 22, 1236535329),
                g = l(g, y, b, _, w[f + 1], 5, 4129170786),
                _ = l(_, g, y, b, w[f + 6], 9, 3225465664),
                b = l(b, _, g, y, w[f + 11], 14, 643717713),
                y = l(y, b, _, g, w[f + 0], 20, 3921069994),
                g = l(g, y, b, _, w[f + 5], 5, 3593408605),
                _ = l(_, g, y, b, w[f + 10], 9, 38016083),
                b = l(b, _, g, y, w[f + 15], 14, 3634488961),
                y = l(y, b, _, g, w[f + 4], 20, 3889429448),
                g = l(g, y, b, _, w[f + 9], 5, 568446438),
                _ = l(_, g, y, b, w[f + 14], 9, 3275163606),
                b = l(b, _, g, y, w[f + 3], 14, 4107603335),
                y = l(y, b, _, g, w[f + 8], 20, 1163531501),
                g = l(g, y, b, _, w[f + 13], 5, 2850285829),
                _ = l(_, g, y, b, w[f + 2], 9, 4243563512),
                b = l(b, _, g, y, w[f + 7], 14, 1735328473),
                y = l(y, b, _, g, w[f + 12], 20, 2368359562),
                g = c(g, y, b, _, w[f + 5], 4, 4294588738),
                _ = c(_, g, y, b, w[f + 8], 11, 2272392833),
                b = c(b, _, g, y, w[f + 11], 16, 1839030562),
                y = c(y, b, _, g, w[f + 14], 23, 4259657740),
                g = c(g, y, b, _, w[f + 1], 4, 2763975236),
                _ = c(_, g, y, b, w[f + 4], 11, 1272893353),
                b = c(b, _, g, y, w[f + 7], 16, 4139469664),
                y = c(y, b, _, g, w[f + 10], 23, 3200236656),
                g = c(g, y, b, _, w[f + 13], 4, 681279174),
                _ = c(_, g, y, b, w[f + 0], 11, 3936430074),
                b = c(b, _, g, y, w[f + 3], 16, 3572445317),
                y = c(y, b, _, g, w[f + 6], 23, 76029189),
                g = c(g, y, b, _, w[f + 9], 4, 3654602809),
                _ = c(_, g, y, b, w[f + 12], 11, 3873151461),
                b = c(b, _, g, y, w[f + 15], 16, 530742520),
                y = c(y, b, _, g, w[f + 2], 23, 3299628645),
                g = u(g, y, b, _, w[f + 0], 6, 4096336452),
                _ = u(_, g, y, b, w[f + 7], 10, 1126891415),
                b = u(b, _, g, y, w[f + 14], 15, 2878612391),
                y = u(y, b, _, g, w[f + 5], 21, 4237533241),
                g = u(g, y, b, _, w[f + 12], 6, 1700485571),
                _ = u(_, g, y, b, w[f + 3], 10, 2399980690),
                b = u(b, _, g, y, w[f + 10], 15, 4293915773),
                y = u(y, b, _, g, w[f + 1], 21, 2240044497),
                g = u(g, y, b, _, w[f + 8], 6, 1873313359),
                _ = u(_, g, y, b, w[f + 15], 10, 4264355552),
                b = u(b, _, g, y, w[f + 6], 15, 2734768916),
                y = u(y, b, _, g, w[f + 13], 21, 1309151649),
                g = u(g, y, b, _, w[f + 4], 6, 4149444226),
                _ = u(_, g, y, b, w[f + 11], 10, 3174756917),
                b = u(b, _, g, y, w[f + 2], 15, 718787259),
                y = u(y, b, _, g, w[f + 9], 21, 3951481745),
                g = n(g, p),
                y = n(y, h),
                b = n(b, v),
                _ = n(_, m);
        ...
        var h = f.resolve();
        try {
            e.localStorage.setItem("@private", "false")
        } catch (e) {
            !1
        }
        var v = {
        ...
        (function() {
            ...
            var r = ["taobao.net", "taobao.com", "tmall.com", "tmall.hk", "alibaba-inc.com"]
              , o = new RegExp("([^.]*?)\\.?((?:" + r.join(")|(?:").replace(/\./g, "\\.") + "))","i")
              , i = t.match(o) || []
              , a = i[2] || "taobao.com"
              , s = i[1] || "m";
        ...
        d.prototype.__processRequestType = function(n) {
            var r = this
              , o = this.options;
            if (!0 === v.H5Request && (o.H5Request = !0),
            !0 === v.WindVaneRequest && (o.WindVaneRequest = !0),
            !1 === o.H5Request && !0 === o.WindVaneRequest) {
                if (!t.windvane || parseFloat(o.WindVaneVersion) < 5.4)
                    throw new Error("WINDVANE_NOT_FOUND::缺少WindVane环境")
            } else
                !0 === o.H5Request ? o.WindVaneRequest = !1 : void 0 === o.WindVaneRequest && void 0 === o.H5Request && (t.windvane && parseFloat(o.WindVaneVersion) >= 5.4 ? o.WindVaneRequest = !0 : o.H5Request = !0);
            var i = e.navigator.userAgent.toLowerCase();
            return i.indexOf("youku") > -1 && o.mainDomain.indexOf("youku.com") < 0 && (o.WindVaneRequest = !1,
            o.H5Request = !0),
            o.mainDomain.indexOf("youku.com") > -1 && i.indexOf("youku") < 0 && (o.WindVaneRequest = !1,
            o.H5Request = !0),
            n ? n().then(function() {
                var e = o.retJson.ret;
                return e instanceof Array && (e = e.join(",")),
                !0 === o.WindVaneRequest && (!e || e.indexOf("PARAM_PARSE_ERROR") > -1 || e.indexOf("HY_FAILED") > -1 || e.indexOf("HY_NO_HANDLER") > -1 || e.indexOf("HY_CLOSED") > -1 || e.indexOf("HY_EXCEPTION") > -1 || e.indexOf("HY_NO_PERMISSION") > -1) ? (v.H5Request = !0,
                r.__sequence([r.__processRequestType, r.__processToken, r.__processRequestUrl, r.middlewares, r.__processRequest])) : void 0
            }) : void 0
        }
        ;
        var b = "_m_h5_c"
        ...
        d.prototype.__getTokenFromAlipay = function() {
            ...
            !!location.protocol.match(/^https?\:$/))
              , i = "AP" === r.AliAppName && parseFloat(r.AliAppVersion) >= 8.2;
            return !0 === r.useAlipayJSBridge && !o && i && e.AlipayJSBridge && e.AlipayJSBridge.call ? e.AlipayJSBridge.call("getMtopToken", function(e) {
        ...
        d.prototype.__getTokenFromCookie = function() {
            var e = this.options;
            return e.CDR && c(b) ? e.token = c(b).split(";")[0] : e.token = e.token || c(_),
        ...
        d.prototype.__processToken = function(e) {
            ...
            !0 !== n.WindVaneRequest ? h.then(function() {
                ...
                r.indexOf("TOKEN_EMPTY") > -1 || !0 === n.CDR && r.indexOf("ILLEGAL_ACCESS") > -1 || r.indexOf("TOKEN_EXOIRED") > -1) {
        ...
        d.prototype.__requestJSONP = function(e) {
            ...
            var r = n()
              ...
              , s = this.options
              , l = a.timeout || 2e4
              , c = "mtopjsonp" + (a.jsonpIncPrefix || "") + ++w
            ...
            return d.src = s.path + "?" + i(s.querystring) + "&" + i(s.postdata),
            d.async = !0,
            d.onerror = function() {
                t("ABORT"),
                e("ABORT::接口异常退出")
        ...
        d.prototype.__requestJSON = function(t) {
            ...
            ;
            var f, p, h = s.path + "?" + i(s.querystring);
            if (s.getJSON ? (f = "GET",
            h += "&" + i(s.postdata)) : s.postJSON && (f = "POST",
            p = i(s.postdata)),
            l.open(f, h, !0),
            l.withCredentials = !0,
        ...
        d.prototype.__requestWindVane = function(e) {
            ...
            var f, p, h = "https" === location.protocol ? 1 : 0, v = i.isSec || 0, m = i.sessionOption || "AutoLoginOnly", g = i.ecode || 0;
            return p = void 0 !== i.timer ? parseInt(i.timer) : void 0 !== i.timeout ? parseInt(i.timeout) : 2e4,
            f = 2 * p,
            !0 === i.needLogin && void 0 === i.sessionOption && (m = "AutoLoginAndManualLogin"),
            void 0 !== i.secType && void 0 === i.isSec && (v = i.secType),
        ...
        d.prototype.__processRequest = function(e, t) {
            ...
            return h.then(function() {
                ...
                r.indexOf("SUCCESS") > -1 ? t.retType = g.SUCCESS : t.retType = g.ERROR,
                e.retJson = t
            })
        }
        ,
        ...
        d.prototype.request = function(t) {
            var n = this;
            this.options = r(t || {}, v);
            var o = f.resolve([E, x]).then(function(e) {
                var t = e[0]
                  , r = e[1];
                ...
                return e.retType !== g.SUCCESS ? f.reject(e) : n.options.successCallback ? void n.options.successCallback(e) : f.resolve(e)
            }).catch(function(e) {
                var t;
                ...
                n.options.failureCallback ? void n.options.failureCallback(t) : f.reject(t)
            });
            return this.__processRequestType(),
            n.options.H5Request && (n.constructor.__firstProcessor || (n.constructor.__firstProcessor = o),
            E = function(e) {
        ...
        ,
        t.mtop.middlewares = m,
        t.mtop.config = v,
        t.mtop.RESPONSE_TYPE = g,
        t.mtop.CLASS = d
    }(window, window.lib || (window.lib = {})),
    function(e, t) {
        function n(e) {
        ...
        function o(t, r) {
            ...
            f.style.cssText = ["width:100%", "height:100%", "border:0", "overflow:hidden"].join(";"),
            ...
            f.style.cssText = ["position:absolute", "top:92px", "left:" + (l / 2 - 185) + "px", "width:370px", "height:480px", "border:0", "background:#FFF", "overflow:hidden"].join(";")),
            u.appendChild(d),
            a.appendChild(u),
            a.appendChild(f),
        ...
        t.mtop.middlewares.push(function(e) {
            ...
            return e().then(function() {
                ...
                (i.indexOf("SESSION_EXPIRED") > -1 || i.indexOf("SID_INVALID") > -1 || i.indexOf("AUTH_REJECT") > -1 || i.indexOf("NEED_LOGIN") > -1) && (e.retType = l.SESSION_EXPIRED,
                !r.WindVaneRequest && (!0 === s.LoginRequest || !0 === r.LoginRequest || !0 === o.needLogin))) {
                    if (!t.login)
        ...
        t.mtop.middlewares.push(function(e) {
            var t = this.options;
            return this.params,
            !0 !== t.H5Request || !0 !== s.AntiFlood && !0 !== t.AntiFlood ? void e() : e().then(function() {
                var e = t.retJson
                  , n = e.ret;
                        ...
                        function u(t) {
                            ...
                            if (o && "child" === o.type) {
                                ...
                                try {
                                    ...
                                    for (var p in f)
                                        l[p] = f[p];
                                    !0 === a.saveAntiCreepToken ? (document.cookie = c + "=" + JSON.stringify(f) + ";",
...
, function(e, t) {
    ...
    function(e, t, n) {
        ...
        function i(t, n) {
            ...
            d.innerText = "关闭";
            var f = document.createElement("iframe");
            f.style.cssText = ["width:100%", "height:" + window.innerHeight / i + "px", "border:0", "overflow:hidden"].join(";"),
            u.appendChild(d),
            a.appendChild(u),
            a.appendChild(f),
        ...
        function l(t, n, r) {
            ...
            function s(t) {
                var n = t.data || {};
                n && "child" === n.type && n.content.indexOf("SUCCESS") > -1 ? (c.removeEventListener("close", o),
                e.removeEventListener("message", s),
                c.hide(),
                r("SUCCESS")) : r("FAILURE")
            }
        ...
        function c(t, n, r) {
            ...
            e.wvLoginCallback = function(t) {
                ...
                r(t.indexOf(":SUCCESS") > -1 ? "SUCCESS" : t.indexOf(":CANCEL") > -1 ? "CANCEL" : "FAILURE")
            }
            ,
            s(o)
        }
        function u(e, t, n) {
            ...
            t = t || {},
            n && y ? c(e, t, n) : n && !g && "login" === e ? l(e, t, n) : s(a(e, {
        ...
        function d(e, t, n) {
            ...
            u(e, t, function(e) {
                n && n(e),
                "SUCCESS" === e ? r && r.resolve(e) : r && r.reject(e)
            }),
            r ? r.promise : void 0
        }
        var f = e.Promise
        ...
        t.login.isLoginAsync = function(e) {
            ...
            this.isLogin(function(n, r) {
                e && e(n, r),
                !0 === n ? t && t.resolve(r) : t && t.reject(r)
            }),
            t ? t.promise : void 0
        }
        ,
        t.login.getUserNick = function(e) {
            if (!e || "function" != typeof e) {
                var t = ""
                  ...
                  , i = r("_nk_") || r("snk")
                  , a = r("sn");
                return o && o.length > 0 && "null" != o ? t = decodeURIComponent(o) : i && i.length > 0 && "null" != i ? t = unescape(unescape(i).replace(/\\u/g, "%u")) : a && a.length > 0 && "null" != a && (t = decodeURIComponent(a)),
        ...
        ,
        t.login.generateUrl = a,
        t.login.goLogin = function(e) {
            u("login", e)
        }
        ,
...
, function(e, t, n) {
    ...
    c.default.ACK_ERROR_CODE)
      ...
      , g = function() {
        function e(t) {
            o(this, e),
            t.serviceId ? (this.MsgHeader = t.MsgHeader,
            this.conn = t.conn,
            this.serviceId = t.serviceId,
            this.emitter = new l.default,
            this.conn && this.__addEventListener(),
            this.mode = t.mode || "ws",
            this.context = t.context) : console.error("serviceId is null!")
        }
        return i(e, [{
            ...
            value: function() {
                ...
                this.conn.onMessage(this.serviceId, function(t) {
                    ...
                    t.getBinaryArray().then(function(t) {
                        ...
                        console.error("accs binary error"),
                        console.log(e)
                    })
                })
            }
            ...
            value: function(e) {
                ...
                for (var n = t.length, r = null, o = 0; o < n; o++) {
                    ...
                    var i = null;
                    try {
                        i = this.baseMsg.decodeMsgHeader(r.msgHeaderBuffer),
                        r.msgHeader = i,
                        -1 === h.msgIdArgs.indexOf(i.messageId) ? (h.msgIdArgs.push(i.messageId),
                        this.processprotocolData(r)) : d.default.emit("ack", {
            ...
            value: function(e, t) {
                ...
                h.protocolBufferStack = [],
                h.msgSize = 0,
                this.conn.send(this.serviceId, n, !0).then(function(e) {
            ...
            value: function(e) {
                ...
                if (r.getStatusCode() && 1e3 !== r.getStatusCode())
                    return console.error("On message error, @errCode: " + r.getStatusCode() + "!"),
                    void d.default.emit("ack", {
            ...
            key: "sendInfoMsg",
            value: function(e) {
                return e.msgType = a.default.MSG_TYPE.MKT_PROTOCOL_MSGTYPE_PUBLISH,
                e.type = a.default.TYPE.MKT_MSG_TYPE_INFO,
                this.sendMsg(e)
            }
        }, {
            key: "sendRequestMsg",
            value: function(e) {
                return e.msgType = a.default.MSG_TYPE.MKT_PROTOCOL_MSGTYPE_PUBLISH,
                e.type = a.default.TYPE.MKT_MSG_TYPE_REQUEST,
                this.sendMsg(e)
            }
        }, {
            key: "sendCommandMsg",
            value: function(e) {
                return e.msgType = a.default.MSG_TYPE.MKT_PROTOCOL_MSGTYPE_PUBLISH,
                e.type = a.default.TYPE.MKT_MSG_TYPE_COMMAND,
                this.sendMsg(e)
            }
        }, {
            key: "sendCountMsg",
            value: function(e) {
                return e.msgType = a.default.MSG_TYPE.MKT_PROTOCOL_MSGTYPE_PUBLISH,
                e.type = a.default.TYPE.MKT_MSG_TYPE_COUNT,
                this.sendMsg(e)
            }
        }, {
            key: "sendMsg",
            value: function(e) {
                ...
                return new Promise(function(n, r) {
                    ...
                    if (clearTimeout(v),
                    v = null,
                    h.msgSize + i.buffer.byteLength >= a.default.MSG_SEND_CONF.MAX_MSG_SIZE && t.__sendAllCacheMsg(n, r),
                    o - p > a.default.MSG_SEND_CONF.INTERVAL)
                        ...
                        var l = i.buffer;
                        h.protocolBufferStack.push(l),
                        h.accsResolveStack.push(n),
                        h.accsRejectStack.push(r),
                        h.msgSize += l.byteLength,
      ...
      , m = {
        ...
        init: function(e) {
            ...
            v)
                return this;
            v = !0,
            o.default.on("ack", function(e) {
                var n = (e.protocolData.msgHeader || {}).monitorTag
                  , r = t.__monitorHandle(e);
                t.confList.MONITOR_RANGE_OPEN && (null != n && n > 0 ? (p.push(r),
                h && p.length < 4999 ? t.confList.MONITOR_RANGE_DELAY = 1e3 * n < t.confList.MONITOR_RANGE_DELAY ? 1e3 * n : t.confList.MONITOR_RANGE_DELAY : t.uploadHandle(t.confList.MONITOR_RANGE_DELAY)) : -1 === n || p.length >= 5e3 ? (p.push(r),
                t.uploadHandle(t.confList.MONITOR_RANGE_DELAY)) : (p.push(r),
                h && p.length < 4999 ? t.confList.MONITOR_RANGE_DELAY = 1e3 * n < t.confList.MONITOR_RANGE_DELAY ? 1e3 * n : t.confList.MONITOR_RANGE_DELAY : t.uploadHandle(t.confList.MONITOR_RANGE_DELAY)))
            })
        },
        ...
        __monitorHandle: function(e) {
            ...
            t.msgHeader || (t.msgHeader = {}),
            t.msgBody || (t.msgBody = {});
            var n = t.msgType
              , r = this.__recordBaseData(e.context, e.protocolData);
            return r.code = e.errorCode,
            n === l.default.MSG_TYPE.MKT_PROTOCOL_MSGTYPE_SUBACK ? (r.type = 3,
            r.source = 0,
            r.mark = 0,
            r.id = "nodid") : n === l.default.MSG_TYPE.MKT_PROTOCOL_MSGTYPE_UNSUBACK ? (r.type = 2,
            r.source = 0,
            r.mark = 0,
            r.id = "nodid") : (r.type = 1,
            r.source = 1,
            t.msgHeader.monitorTag > 0 || -1 === t.msgHeader.monitorTag ? r.mark = 1 : r.mark = 0,
            this.confList.MONITOR_RANGE_DOWNGRADE && (r.source = 2),
            r.id = e.protocolData.msgHeader.messageId || "nodid"),
            r
        },
    ...
    1)
      ...
      , d = function() {
        function e() {
            ...
            var r = {};
            void 0 !== t.msgType && (r.msgType = t.msgType),
            void 0 !== t.type && (r.type = t.type),
            r.typeVersion = l,
            r.DUP = t.DUP,
            r.Qos = t.Qos,
            r.retain = t.retain || 0,
        ...
        return i(e, [{
            ...
            value: function(e, t) {
                ...
                this.msgHeader = new this.constanse.MsgHeader.MKTProtoHeader,
                this.msgHeader.setUserId(this.userId || ""),
                this.msgHeader.setToken(this.token || "");
                var o = this.msgHeader;
                return o.setTopic(e.toString()),
                "number" == typeof t && o.setSubType(t, r),
                o.setPriority(n, r),
                o.setSdkVersion("h5_" + a.default.version),
                o.setAppVersion(navigator.appVersion + " LibMessageKitSdk/" + (new Date).getTime()),
                o.setMessageId(this.__generateMessageId()),
                this.protocolData.msgHeaderBuffer = o.toArrayBuffer(),
                logs("%c [msgHeader为]", "color: #f40;"),
                logs(o),
                logs("%c [end]", "color: #f40;"),
                o
            }
        }, {
            key: "decodeMsgHeader",
    ...
    var r = function(e) {
      ...
      , o = {
        ...
        setMsgBody: function(e, t) {
            return this.store.msgBody.expression.set(e, t),
            this.store.msgBody
        },
...
, function(e, t, n) {
    ...
    var o = r(n(160))
      , i = {
        ...
        setMsgBody: function(e, t) {
            return e && this.store.msgBody.setIndex(parseInt(e), this.store.INT64),
            t && this.store.msgBody.setPageSize(parseInt(t), this.store.INT32),
            this.store.msgBody
        },
        decodeMsgBody: function(e) {
    ...
    var r = function(e) {
      ...
      , o = {
        ...
        setMsgBody: function(e, t, n, r) {
            return e && this.store.msgBody.setPermission(e),
            t && this.store.msgBody.setPeriodTime(t),
            n && this.store.msgBody.setType(n),
            r && this.store.msgBody.setSubType(r),
            this.store.msgBody
        },
        decodeMsgBody: function(e) {
...
, function(e, t, n) {
    ...
    var o = r(n(160))
      , i = {
        ...
        setMsgBody: function(e, t, n, r) {
            e && this.store.msgBody.setFrom(e),
            t && this.store.msgBody.setTo(t),
            n && this.store.msgBody.setSendTags(n),
            this.store.msgBody.setSendFullTags(r);
            var o = (new Date).getTime();
            return this.store.msgBody.setTimestamp(parseInt(o), this.store.INT64),
            this.store.msgBody
        },
        decodeMsgBody: function(e) {
...
, function(e, t, n) {
    ...
    var o = r(n(160))
      , i = {
        ...
        setMsgBody: function(e, t, n, r) {
            return e && this.store.msgBody.setFrom(e),
            t && this.store.msgBody.setRole(parseInt(t), this.store.INT32),
            n && this.store.msgBody.setBizTag(n),
            r && this.store.msgBody.setPageSize(parseInt(r), this.store.INT32),
            this.store.msgBody
        },
        decodeMsgBody: function(e) {
...
, function(e, t, n) {
    ...
    var o = r(n(168))
      ...
      , l = {
        init: function() {
            var e = !(arguments.length > 0 && void 0 !== arguments[0]) || arguments[0];
            if (this.needTbMessage = e,
            e && dcodeIO.ProtoBuf && dcodeIO.Long) {
                var t = null
                  , n = null;
                try {
                    t = dcodeIO.ProtoBuf.newBuilder({}).import(a.default).build(),
                    n = new dcodeIO.Long(16,16)
                } catch (e) {
                    console.error("protobufjs need to be required!!"),
                    console.log(e)
                }
                this.store = {
                    TBLiveMessage: t,
                ...
                !function() {
                    ...
                    case s.STUDIO_MSG:
                        try {
                            ...
                            "liveVideoStreamRestore" == v ? e.emit("liveRestore", h) : "liveVideoStreamBreak" == v && e.emit("liveBrk", h),
                            d = h
                        } catch (e) {}
                        break;
                    case s.SHARE_MSG:
                    ...
                    case s.BIZ_MSG:
                        try {
                            var y = "";
                            y = "base64" === n.type ? JSON.parse(o.default.utf8ToUtf16(atob(u))) : JSON.parse(o.default.utf8ToUtf16(o.default.binarryToStr(u))),
                            e.emit("liveInteractive", {
                                data: y
                            }),
                            e.emit("liveMovement", {
                                data: y,
                    ...
                    case s.TRADE_SHOW:
                        ...
                        break;
                    default:
                        d = "base64" === n.type ? n.content : window.btoa(o.default.utf8ToUtf16(o.default.binarryToStr(n.content))),
                        a.decodeMsgData = d,
                        e.emit("bizInfo", a)
                    }
                }();
        ...
        getJoinMsg: function() {
            ...
            r.setTotalCount(t, this.store.INT32),
            r.setOnlineCount(n, this.store.INT32),
            r
        }
    };
    t.default = {
      ...
      , d = function() {
        ...
        return i(e, [{
            ...
            value: function() {
                ...
                e.src = "https://aeu.alicdn.com/ctl/ctl.js",
            ...
            key: "bind",
            value: function() {
                this.env = new l.default,
                this.render = new s.default({
            ...
            value: function() {
                ...
                this.render.on("after::render", function() {}),
                this.env.on("env::close", function() {
                    e.render.close()
                }),
...
, function(e, t) {
    ...
    t.CANVAS_SELECTOR = "interactive-canvas",
    t.MATERIAL_URL = [{
        name: "coupon",
        bundleUrl: ""
    }],
    ...
    l.MATERIAL_URL)
      ...
      , f = function(e) {
        ...
        s(t, [{
            ...
            value: function(e) {
                this.canvas = e,
                "string" == typeof e && (this.canvas = document.querySelector("#" + e)),
                this.canvas || (this.canvas = document.createElement("div"),
                this.canvas.id = l.CANVAS_SELECTOR,
            ...
            value: function(e) {
                ...
                this.empty(),
                this.renderWrap(this.canvas),
                this.downloadBundle(n, e)
            }
        }, {
            key: "_getScript",
            value: function(e) {
            ...
            value: function(e, t) {
                ...
                this._getScript(e, function() {
                    ...
                    e.className = "canvas-show",
                    clearTimeout(d),
                    n.hideModuleAfterTimeout(t.duration)
                }),
    ...
    r(n(180)))
      , c = function(e) {
        function t() {
            ...
            return e.UTLIS = {},
            e.registerDefaultModule(),
            e
        }
        return a(t, l.default),
        s(t, [{
            key: "register",
            value: function(e) {
                var t = this;
...
, function(e, t, n) {
    !function(t, n) {
        ...
        , function(e, t, n) {
            ...
            function s(e) {
                return function(t, n) {
                    return o(t) ? (o(n) && (n = document.querySelector(n)),
                    (f(n) ? n : document)[e](t)) : document[e](null)
                }
            }
            function l(e, t) {
                return e.classList ? e.classList.contains(t) : (i(t),
                a(t).test(e.className))
            }
            function c(e, t) {
                return e.classList ? e.classList.add(t) : l(e, t) || (e.className = (e.className + " " + t).trim()),
                e
            }
            function u(e, t) {
            ...
            function f(e) {
                ...
                g.default)(e)) && 1 === e.nodeType
            }
            function p(e) {
                return !!e && "object" === (void 0 === e ? "undefined" : (0,
                g.default)(e)) && 3 === e.nodeType
            }
            function h(e) {
                for (; e.firstChild; )
                    e.removeChild(e.firstChild);
            ...
            function v(e) {
                ...
                (Array.isArray(e) ? e : [e]).map(function(e) {
                    return "function" == typeof e && (e = e()),
                    f(e) || p(e) ? e : "string" == typeof e && /\S/.test(e) ? document.createTextNode(e) : void 0
                }).filter(function(e) {
                    return e
                })
            }
            ...
            t.addElClass = c,
            t.removeElClass = u,
            t.toggleElClass = function(e, t, n) {
                var r = l(e, t);
                if ("function" == typeof n && (n = n(e, t)),
                "boolean" != typeof n && (n = !r),
                n !== r)
                    return n ? c(e, t) : u(e, t),
                    e
            }
            ,
            ...
            t.getElAttributes = function(e) {
                ...
                e && e.attributes && e.attributes.length > 0)
                    for (var a = (r = e.attributes).length - 1; a >= 0; a--)
                        o = r[a].name,
                        i = r[a].value,
                        "boolean" != typeof e[o] && -1 === n.indexOf("," + o + ",") || (i = null !== i),
                        t[o] = i;
                return t
            }
            ,
            ...
            t.getPointerPosition = function(e, t) {
                var n = {}
                  ...
                  , l = t.pageY
                  , c = t.pageX;
                return t.changedTouches && (c = t.changedTouches[0].pageX,
                l = t.changedTouches[0].pageY),
                n.y = Math.max(0, Math.min(1, (a - l + i) / i)),
                n.x = Math.max(0, Math.min(1, (c - s) / o)),
                n
            }
            ,
            t.isEl = f,
            t.isTextNode = p,
            t.emptyEl = h,
            t.normalizeContent = v,
            t.appendContent = m,
            t.insertContent = function(e, t) {
                return m(h(e), t)
            }
            ;
            var y = function(e) {
        ...
        , function(e, t, n) {
            var r = n(0)
              ...
              , a = n(9)
              , s = function(e, t, n) {
                var l, c, u, d = e & s.F, f = e & s.G, p = e & s.S, h = e & s.P, v = e & s.B, m = e & s.W, g = f ? o : o[t] || (o[t] = {}), y = g.prototype, b = f ? r : p ? r[t] : (r[t] || {}).prototype;
                f && (n = t);
                for (l in n)
                    (c = !d && b && void 0 !== b[l]) && l in g || (u = c ? b[l] : n[l],
                    g[l] = f && "function" != typeof b[l] ? n[l] : v && c ? i(u, r) : m && b[l] == u ? function(e) {
        ...
        , function(e, t, n) {
            ...
            function r(e, t) {
                ...
                i[e].apply ? i[e].apply(i, n) : i[e](n.join(" "))
            }
            Object.defineProperty(t, "__esModule", {
                value: !0
            });
        ...
        , function(e, t) {
            ...
            !function(e) {
                ...
                for (var l in new t)
                    s.push(l);
                a.enumErrorProps = o.call(r, "message") || o.call(r, "name"),
                a.enumPrototypes = o.call(t, "prototype"),
                a.nonEnumShadows = !/valueOf/.test(s),
                a.ownLast = "x" != s[0],
                a.spliceObjects = (i.call(n, 0, 1),
                !n[0]),
        ...
        , function(e, t, n) {
            var r = n(18)
              ...
              , s = function() {}
              , l = function() {
                var e, t = n(56)("iframe"), r = i.length;
        ...
        , function(e, t, n) {
            ...
            function o(e) {
                return !!e && "object" === (void 0 === e ? "undefined" : (0,
                a.default)(e)) && "[object Object]" === e.toString() && e.constructor === Object
            }
            function i() {
                var e = Array.prototype.slice.call(arguments);
                return e.unshift({}),
        ...
        , function(e, t, n) {
            ...
            e.exports = function(e) {
                ...
                if (d.nonEnumShadows && e !== g) {
                    ...
                    t = v.length; t--; ) {
                        var L = A[k = v[t]];
                        x && L || (L ? !b.call(e, k) : e[k] === E[k]) || T.push(k)
                    }
                }
                return T
            }
        ...
        , function(e, t, n) {
            ...
            function a(e, t, n) {
                ...
                o && !t.isPropagationStopped() && !0 === t.bubbles)
                    a.call(null, o, t, n);
                else if (!o && !t.defaultPrevented) {
                    var i = d.getElData(t.target);
                    t.target[t.type] && (i.disabled = !0,
            ...
            function s(e, t, n) {
                ...
                r.guid = n.guid = n.guid || f.newGUID(),
                o(e, t, r)
            }
            function l(e) {
                function t() {
            ...
            function c(e, t) {
                ...
                delete n.dispatcher,
                delete n.disabled),
                0 === Object.getOwnPropertyNames(n).length && d.removeElData(e)
            }
            function u(e, t, n, r) {
        ...
        , function(e, t, n) {
            ...
            e.exports = function(e, t, n, v, m, g, y) {
                ...
                }, x = t + " Iterator", T = "values" == m, S = !1, C = e.prototype, O = C[f] || C["@@iterator"] || m && C[m], k = O || E(m), M = m ? T ? E("entries") : k : void 0, A = "Array" == t ? C.entries || O : O;
                if (A && (w = d(A.call(new e))) !== Object.prototype && w.next && (u(w, x, !0),
                r || s(w, f) || a(w, f, h)),
            ...
            var i = o(n(1))
              ...
              , w = function(e) {
                function t(e) {
                    ...
                    n.options = (0,
                    u.default)(n.options, o),
                    n.rootElement = r.rootElement,
                    n.screen = "Vertical",
                ...
                a.default)(t, [{
                    ...
                    value: function() {
                        this.videox.on(y.default.INIT, this.onInit.bind(this)),
                        this.videox.on(y.default.VIDEO_CLICK, this.onVideoClick.bind(this)),
                    ...
                    value: function() {
                        ...
                        (v.aliapp && "TB" == v.aliapp.appname && !r && v.os.isAndroid || this.options.noFullscreen || !1 === this.options.controls) && (e = "vjs-hidden"),
                        !1 !== this.options.controls && !0 !== this.options.live || (t = "vjs-hidden"),
                        ...
                        return c.appendContent(this.rootElement, o),
                        o
                    }
                }, {
                    key: "bindEvent",
                    ...
                    value: function(e) {
                        ...
                        var t = e.target;
                        e.preventDefault(),
                        c.hasElClass(t, this.options.playButtonClassName) ? this.playButton(t) : c.hasElClass(t, this.options.playFullscreenClassName) ? this.fullscreenButton(t) : c.hasElClass(t, this.options.itemClassName) && this.player.emit("video:item:click")
                    }
                }, {
                    ...
                    value: function() {
                        ...
                        e.paused && e.networkState <= e.HAVE_METADATA ? (e.play(),
                        setTimeout(function() {
                            e.pause(),
                            e.webkitEnterFullScreen()
                        }, 0)) : this.canFullScreen_() || v.os.isIPhone ? e.webkitEnterFullScreen() : this.rotatePage_(),
                    ...
                    value: function(e) {
                        ...
                        this.transverseFullScreen_(n, function(e) {
                            !e && n ? (c.addElClass(document.body, "vjs-body-fullscreen"),
                            c.addElClass(t.rootElement, "vjs-player-fullscreen"),
                            window.scrollTo(0, 0),
                            t.screen = "landscape",
                            t.player.emit("video:enterFullscreen")) : e || n ? (t.videoPlayer.enterFullScreen(),
                            t.player.emit("video:enterFullscreen")) : (c.removeElClass(document.body, "vjs-body-fullscreen"),
                            c.removeElClass(t.rootElement, "vjs-player-fullscreen"),
                            t.screen = "Vertical",
                            window.scrollTo(0, t.rootElement.offsetTop - window.scrollY),
                            t.player.emit("video:exitFullscreen"))
                        })
                    }
                }, {
                    ...
                    value: function(e) {
                        ...
                        n ? window.WindVane.call("WebAppInterface", "setNaviBarHidden", {
                            ...
                            t._canSetNav = !0,
                            t.rotatePage_(),
                            t.player.emit("video:enterFullscreen")
                        }, function() {
                            t._canSetNav = !1,
                    ...
                    value: function(e, t) {
                        this.showControlBar(),
                        c.hasElClass(e, this.options.playStatusButtonClassName) ? this.exePause(e, t) : this.exePlay(e, t)
                    }
                }, {
                    key: "playEnded",
                    value: function() {
                    ...
                    value: function(e, t) {
                        c.addElClass(this.playBtnEl, this.options.playStatusButtonClassName),
                        !t && this.videox.emit(y.default.TRIGGER_PLAY, {})
                    }
                }, {
                    key: "exePause",
                    value: function(e, t) {
                        c.removeElClass(this.playBtnEl, this.options.playStatusButtonClassName),
                        t || this.videox.emit(y.default.TRIGGER_PAUSE, {})
                    }
                }, {
                    key: "canFullScreen_",
                    value: function() {
                    ...
                    value: function() {
                        ...
                        this.rootElement.style.width = r,
                        document.body.style.height = n,
                        this.screen = "landscape",
                        window.scrollTo(0, 0),
                        h.on(this.rootElement, "touchmove", _),
                    ...
                    value: function() {
                        ...
                        this.screen = "Vertical",
                        h.off(this.rootElement, "touchmove", _),
                        setTimeout(function() {
        ...
        , function(e, t, n) {
            ...
            if (o = a.match(/Windows\sPhone\s(?:OS\s)?([\d\.]+)/))
                ...
                a.match(/Mobile\s+Safari/) ? (r.name = "Android",
                r.isAndroid = !0) : (r.name = "AndroidPad",
                r.isAndroidPad = !0);
        ...
        , function(e, t, n) {
            ...
            var m = function(e) {
                function t() {
                    ...
                    o.default)(this, t);
                    var n = (0,
                    i.default)(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this));
                    ...
                    n.player = new u.default(n),
                    !1 !== e.controls && (n.controlBar = new d.default(n)),
                    n._initLogTrack(),
                ...
                a.default)(t, [{
                    ...
                    value: function() {
                        ...
                        Object.assign(e, this.config),
                        this.logTrack = new h.default(e)
                    }
                }, {
                    key: "_bindEvent",
                    value: function() {
                        ...
                        this.rootElement.addEventListener("click", function(t) {
                            return e._triggerPlayerClick(t)
                        }, !0)
                    }
                }, {
                    ...
                    value: function(e) {
                        "VIDEO" === e.target.nodeName.toUpperCase() && ("touchend" == e.type && (e.stopPropagation(),
                        e.preventDefault()),
        ...
        , function(e, t, n) {
            ...
            : M
              , G = function(e) {
                var t = X[e] = x(L.prototype);
                return t._k = e,
                t
            }
              , q = V && "symbol" == typeof L.iterator ? function(e) {
            ...
            : function(e) {
              ...
              , J = function(e, t, n) {
                ...
                t = w(t, !0),
                b(n),
                o(X, t) ? (n.enumerable ? (o(e, R) && e[R][t] && (e[R][t] = !1),
                n = x(n, {
                    enumerable: E(0, !1)
                })) : (o(e, R) || M(e, R, E(1, {})),
                e[R][t] = !0),
              ...
              , K = function(e, t) {
                ...
                e !== U || !o(X, t) || o(B, t)) {
                    var n = k(e, t);
                    return !n || !o(X, t) || o(e, R) && e[R][t] || (n.enumerable = !0),
                    n
                }
            }
              , Q = function(e) {
            ...
            n(46).f = W,
            n(60).f = $,
            i && !n(36) && s(U, "propertyIsEnumerable", W, !0),
            h.f = function(e) {
                return G(p(e))
            }
            ),
            ...
            L.prototype[P] || n(9)(L.prototype, P, L.prototype.valueOf),
            d(L, "Symbol"),
            d(Math, "Math", !0),
            d(r.JSON, "JSON", !0)
        }
        ...
        , function(e, t, n) {
            n(110),
            e.exports = n(8).Object.setPrototypeOf
        }
        , function(e, t, n) {
            var r = n(17);
            r(r.S, "Object", {
                setPrototypeOf: n(111).set
            })
        }
        , function(e, t, n) {
            var r = n(19)
            ...
            e.exports = {
                set: Object.setPrototypeOf || ("__proto__"in {} ? function(e, t, r) {
                    try {
                        (r = n(54)(Function.call, n(52).f(Object.prototype, "__proto__").set, 2))(e, []),
            ...
            n(32)))
              ...
              , g = function(e) {
                ...
                a.default)(t, [{
                    key: "_addEventListener",
                    value: function() {
                        this.videox.on(u.default.INIT, this.onInit.bind(this)),
                        this.videox.on(u.default.SOURCE_ATTACHED, this.onSourceAttached.bind(this)),
                        this.videox.on(u.default.TRIGGER_PAUSE, this.onTriggerPause.bind(this)),
                        this.videox.on(u.default.TRIGGER_PLAY, this.onTriggerPlay.bind(this)),
                    ...
                    value: function() {
                        var e = this.opts;
                        "object" === (0,
                        o.default)(e.container) ? this.container = e.container : "string" == typeof e.container && (this.container = (0,
                        p.$)(e.container)),
                        e.from || console.error("参数from为必填项，用作业务埋点统计，请联系@霜草进行分配"),
                        this.video = (0,
                        p.createEl)("video", {
                            className: "lib-video",
                            loop: e.loop || !1,
                        ...
                        this.logTrack = this.videox.logTrack
                    }
                }, {
                    key: "onTriggerPause",
                    value: function() {
                    ...
                    value: function(e) {
                        ...
                        e.reload ? this.play() : this.options.autoplay && ("NATIVE" == this.tagType ? this.video.autoplay = !0 : this.play())
                    }
                }, {
                    key: "_appendSource",
                    value: function(e) {
                        ...
                        "flv" === i)
                            n.e(1).then(n.bind(null, 148)).then(function(e) {
                                if (e.isSupported()) {
                                    var n = {}
                                      , r = e.Events
                                      , i = r.ERROR
                                    ...
                                    f.attachMediaElement(t.video),
                                    f.load(),
                                    t.videox.emit(u.default.SOURCE_ATTACHED, {
                                        tagType: "FLV",
                                        reload: o
                                    }),
                                    f.on(i, function(e) {
                        ...
                        else if ("m3u8" !== i || h.os.isIPhone || f.default.isSafari())
                            if ("m3u8" === i && h.os.isIPhone)
                                this.video.setAttribute("type", m[i] || ""),
                                this.video.setAttribute("src", r);
                            else {
                                ...
                                this.videox.emit(u.default.SOURCE_ATTACHED, {
                                    tagType: "NATIVE",
                                    reload: o
                                })
                            }
                        else
                            n.e(0).then(n.bind(null, 149)).then(function(e) {
                                e.isSupported() ? (t.hlsPlayer = new e(t.options.codecConfig),
                                t.hlsPlayer.attachMedia(t.video),
                                t.hlsPlayer.loadSource(r),
                                t.videoPlayerType = "hls",
                                t.videox.emit(u.default.SOURCE_ATTACHED, {
                                    tagType: "HLS",
                                    reload: o
                                })) : (t.videox.emit(d.default.VIDEO_ERROR, {
                    ...
                    value: function() {
                        ...
                        (0,
                        p.appendContent)(this.rootElement, [this.video, e]),
                        this.startPlayEl = (0,
                    ...
                    value: function(e) {
                        var t = this;
                        this.rootElement,
                        !e && this.startPlayEl.addEventListener("click", function(e) {
                    ...
                    value: function(e) {
                        ...
                        this.videox.emit(d.default.VIDEO_PAUSE, e),
                    ...
                    value: function(e, t) {
                        (0,
                        v.default)("HTML5:emit:::flv:" + e + "::" + (new Date).getTime()),
                        this.emit(e, t)
                    }
                }, {
                    key: "_seekingEmit",
                    value: function(e) {
                        ...
                        this.emit && this.emit(d.default.VIDEO_SEEKING, e)
                    }
                }, {
                    key: "_seekedEmit",
                    value: function(e) {
                        ...
                        this.emit && this.emit(d.default.VIDEO_SEEKED, e)
                    }
                }, {
                    key: "_stalledEmit",
                    value: function(e) {
                        ...
                        this.emit && this.emit(d.default.VIDEO_STALLED, e),
                    ...
                    value: function(e) {
                        ...
                        this.videox.emit(u.default.LOADING),
                        this.videox.emit(d.default.VIDEO_WAITING, e),
                        this._setTimeoutError()
                    }
                }, {
                    key: "_abortEmit",
                    value: function(e) {
                        ...
                        this.emit && this.emit(d.default.VIDEO_ABORT, e)
                    }
                }, {
                    key: "_suspendEmit",
                    value: function(e) {
                        ...
                        this.emit && this.emit(d.default.VIDEO_SUSPEND, e)
                    }
                }, {
                    key: "_canplayEmit",
                    value: function(e) {
                        ...
                        this.emit && this.emit(d.default.VIDEO_CANPLAY, e)
                    }
                }, {
                    ...
                    value: function(e) {
                        ...
                        this.emit && this.emit(d.default.VIDEO_CANPLAYTHROUGH, e)
                    }
                }, {
                    key: "_errorEmit",
                    value: function(e) {
                        ...
                        this.videox.emit(d.default.VIDEO_ERROR, e),
                        this.logTrack.errorLog(e)
                    }
                }, {
                    key: "_progressEmit",
                    value: function() {
                    ...
                    value: function(e) {
                        ...
                        this.videox.emit(d.default.VIDEO_ENDED, e)
                    }
                }, {
                    key: "_timeupdateEmit",
                    value: function(e) {
                        ...
                        this.playEmited || (t > 0 || this.videoLoading && this.options.live && h.os.isAndroid) && (this.waitTimer_ && (clearTimeout(this.waitTimer_),
                        this.waitTimer_ = 0),
                        this.videox.emit(d.default.VIDEO_TIMEUPDATE, e))
                    }
                }, {
                    ...
                    key: "_playEmit",
                    value: function(e) {
                        this.videox.emit(d.default.VIDEO_PLAY, e),
                ...
                return o(v || t, function(o, a) {
                    ...
                    c(o))
                        ...
                        var s = e[a]
                          ...
                          , u = void 0 === l;
                        u && (l = o),
                        void 0 === l && (!h || a in e) || !u && (l === l ? l === s : s !== s) || (e[a] = l)
                    }
                }),
                e
            }
        ...
        , function(e, t, n) {
            ...
            e.exports = function(e, t, n, u, d, f, p) {
                ...
                var m = e[n]
                  ...
                  , y = void 0 === g;
                y && (g = v,
                a(v) && (i(v) || l(v)) ? g = i(m) ? m : a(m) ? r(m) : [] : s(v) || o(v) ? g = o(m) ? c(m) : s(m) ? m : {} : y = !1),
                f.push(v),
                p.push(g),
                y ? e[n] = u(g, v, d, f, p) : (g === g ? g !== m : m === m) && (e[n] = g)
            }
        }
        , function(e, t) {
            e.exports = function(e, t) {
            ...
            e.exports = function(e) {
                return i(function(t, n) {
                    var i = -1
                      ...
                      , l = a > 2 ? n[2] : void 0
                      , c = a > 1 ? n[a - 1] : void 0;
                    for ("function" == typeof s ? (s = r(s, c, 5),
                    a -= 2) : (s = "function" == typeof c ? c : void 0,
                    a -= s ? 1 : 0),
                    l && o(n[0], n[1], l) && (s = a < 3 ? void 0 : s,
                    a = 1); ++i < a; ) {
                        var u = n[i];
                        u && e(t, u, s)
                    }
            ...
            n(32)))
              ...
              , v = function(e) {
                function t(e) {
                    ...
                    i.default)(this, t);
                    var n = (0,
                    s.default)(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e, h.default.VIDEO_TIMEUPDATE));
                    return n.videox = e,
                    ...
                    n.videox.videoDom.addEventListener("loadedmetadata", function(e) {
                ...
                a.default)(t, [{
                    ...
                    value: function() {
                        ...
                        return c.appendContent(c.$(".progress-wrap", this.parent_), t),
                        t
                    }
                }, {
                    key: "bindEvent",
                    value: function() {
                        var e = this
                          ...
                          , i = function(r) {
                            ...
                            t = !0,
                            n = !o.paused,
                            e.setMediaProgress(r)
                        }
                          , a = function(o) {
                            console.log(o.type + ":::mouseUp"),
                            o.preventDefault(),
                            clearInterval(r),
                            t = !1,
                            1 == n && (n = !1),
                          ...
                          , s = function(n) {
                            n.preventDefault(),
                            !0 === t && (r = setInterval(e.setMediaProgress(n), 1e3))
                        };
                    ...
                    value: function(e, t, n) {
                        var r = e.getBoundingClientRect()
                          ...
                          , i = r.width;
                        return u.aliapp && "TB" == u.aliapp.appname && u.os.isAndroid && (o = (t.clientY || t.changedTouches[0].clientY) - r.top,
                        i = r.height),
                        o / i * n
                    }
                }, {
                    ...
                    value: function(e) {
                        var t = this.media
                          , n = 0;
                        t.currentTime > 0 && (n = 100 / t.duration * t.currentTime),
                    ...
                    value: function(e) {
                        ...
                        !0 === isNaN(t.duration) && (r = "00:00"),
                        this.currentTimeEl.innerHTML = n,
                        this.totalTimeEl.innerHTML = r
                    }
                }, {
                    key: "formatTime",
                    value: function(e) {
                    ...
                    value: function(e) {
                        ...
                        return t.style.left = n + "%",
                        c.appendContent(this.progressBarEl, t),
                        t
                    }
                }]),
                t
        ...
        , function(e, t, n) {
            ...
            var o, i, a = r(n(33)), s = r(n(70)), l = window.navigator.userAgent, c = !1, u = "", d = "", f = "";
            (i = l.match(/WindVane[\/\s]([\d\.\_]+)/i)) && (o = i[1]),
            (i = l.match(/AliApp\(([A-Z\-]+)\/([\d\.]+)\)/i)) && (c = !0,
            u = i[1],
            f = i[2],
            d = u.indexOf("-PD") > 0 ? s.default.isIOS ? "iPad" : s.default.isAndroid ? "AndroidPad" : s.default.name : s.default.name),
            !u && l.indexOf("TBIOS") > 0 && (u = "TB");
            var p = window._ua_popLayer || ""
              , h = !1
              , v = "";
            p && (i = p.match(/PopLayer\/([\d\.]+)/i)) && (h = !0,
            v = i[1]),
            c && (c = {
        ...
        , function(e, t, n) {
            ...
            a.match(/IEMobile/) ? (r.name = "IEMobile",
            r.isIEMobile = !0) : (r.name = "IE",
            r.isIE = !0),
            a.match(/Android|iPhone/) && (r.isIELikeWebkit = !0)) : (o = a.match(/(?:Chrome|CriOS)\/([\d\.]+)/)) ? (r = {
                name: "Chrome",
                isChrome: !0,
                version: new i.default(o[1])
            },
            a.match(/Version\/[\d+\.]+\s*Chrome/) && (r.name = "Chrome Webview",
            r.isWebview = !0)) : a.match(/Safari/) && (o = a.match(/Android[\s\/]([\d\.]+)/)) ? r = {
                name: "Android",
                isAndroid: !0,
                version: new i.default(o[1])
        ...
        , function(e, t, n) {
            ...
            var r, o = window.navigator.userAgent;
            r = o.match(/Weibo/i) ? {
                appname: "Weibo",
                isWeibo: !0
            ...
            function(e) {
                ...
                a.default)(t, [{
                    ...
                    value: function() {
                        ...
                        return c.appendContent(c.$(".volume-wrap", this.parent_), e),
                        e
                    }
                }, {
                    key: "bindEvent",
                    value: function() {
                        ...
                        function(n) {
                          ...
                          , i = function(r) {
                            r.preventDefault(),
                            !0 === t && (n = setInterval(e.setMediaVolume(r), 1e3))
                        }
                          , a = function(t) {
                            var n = e.media;
                            n.muted = !n.muted
                    ...
                    value: function() {
                        var e = this.media
                          , t = (e.muted,
                        0);
                        e.volume > 0 && (t = 100 * e.volume),
                        this.progressEl.style.width = t + "%",
                        this.setMediaMutedStatus(e)
                    }
                }, {
                    key: "volumeupdate",
                    value: function() {
                  ...
                  , b = {
                    ...
                    callMethod: function(t, n, r, o) {
                        ...
                        i)
                            ...
                            var c = "hybrid://" + t + ":" + o + "/" + n + "?" + r;
                            s ? (this.setParam(o, r),
                            this.useIframe(o, c)) : l ? window.prompt(c, "wv_hybrid:") : this.onComplete(o, {
                                ret: "HY_NOT_SUPPORT_DEVICE"
                            }, "failure")
                        }
                    },
                ...
                i.default)(e, [{
                    ...
                    value: function() {
                        ...
                        case "m3u8":
                            ...
                            n = e.pathname.split("/")[2].split(".")[0];
                            break;
                        case "mp4":
                            r = "tbvideo",
                            n = e.pathname.split("/").pop().split(".")[0];
                            break;
                        case "flv":
                            r = e.pathname.split("/")[1],
                            n = e.pathname.split("/")[2].split(".")[0]
                    ...
                    value: function() {
                        ...
                        t.on(s.default.VIDEO_SEEKING, function(t) {
                            e.seekLog(),
                            e._recordStartSeekTime()
                        }),
                        t.on(s.default.VIDEO_SEEKED, function(t) {
                            e.seekLog()
                        }),
                        document.addEventListener("visibilitychange", function(t) {
                            "hidden" === document.visibilityState && (e._addPlayTime(),
                            e.exposeLog(),
                            e.playTimeLog())
                        });
                        var n = function() {
                            ...
                            r && !e._isInView ? (e._isInView = !0,
                            e._recordStartExposeTime(),
                            e._isPlaying && e._recordStartTime()) : !r && e._isInView && (e._isInView = !1,
                            e.exposeLog(),
                            e._isPlaying && e._addPlayTime())
                        };
                    ...
                    value: function(e, t) {
                        ...
                        return function() {
                            ...
                            i = arguments;
                            var c = t - (l - n);
                            return c <= 0 || c >= t ? (clearTimeout(r),
                            r = null,
                            a = e.apply(o, i)) : null == r && (r = setTimeout(s, c)),
                            a
                        }
                    }
                }, {
                    ...
                    key: "_getOffset",
                    value: function(e, t) {
                        var e, n, r, o, i, a = window.innerHeight, s = window.innerWidth;
                        if (e)
                            return t || (t = {
                                x: 0,
                                y: 0
                            }),
                            e != window ? (e = e.getBoundingClientRect(),
                            n = e.left,
                            r = e.top,
                            o = e.right,
                            i = e.bottom) : (n = 0,
                    ...
                    value: function() {
                        ...
                        if (e > 10) {
                            ...
                            l && l.record("/taobaolive.videox.seek", "OTHER", t, "H1479648438"),
                            this._startSeekTime = 0
                        }
                    }
                }]),
              ...
              , l = function() {
                ...
                return a(e, [{
                    ...
                    value: function(e) {
                        ...
                        this.protocol = t[1] || ("object" === ("undefined" == typeof location ? "undefined" : i(location)) ? location.protocol : ""),
                        this.username = t[2] || "",
                        this.password = t[3] || "",
                        this.hostname = t[4],
                        this.port = t[5] || "",
                    ...
                    set: function(e) {
                        ("string" == typeof e || e instanceof String) && ((e = e.toString()) && e.indexOf("#") < 0 && (e = "#" + e),
                        this._hash = e || "")
                    }
                }, {
                    key: "host",
    ...
    t.default = {
        ...
        methods: {
            ...
            activeQRcode: function(e) {
                this.qrcodeActive = e,
                goldlog && e && goldlog.record("/taobaolive.pclive.mobilelive", "CLK", "", "H1485189558")
            }
        },
        mounted: function() {
            this.generateQrCode()
...
, function(e, t, n) {
    ...
    t.default = {
        ...
        methods: {
            initMsg: function() {
                ...
                t.on("message", function(t) {
                    ...
                    n.message.indexOf(r) > -1 ? e.chatWindow.addComment({
                        ...
                        class: "follow",
                        shouldMerge: !0
                    }) : (!e.userInfo || e.userInfo.userId !== n.userId && e.userInfo.nickName !== n.from) && (e.colorIndex++,
                    e.colorIndex > 4 && (e.colorIndex = 0),
                ...
                t.on("liveTrade", function(t) {
                    ...
                    if (1 == n.type) {
                        e.chatWindow.addComment({
                            content: '<span style="color:#999;">' + n.nick + " 正在去购买的路上</span>",
                        })
                    }
                }),
            ...
            likeMsg: function() {
                var e = this;
                e.msgScope && (e.likeCount++,
                e.likeAnim.like(),
                e.msgScope.count().then(function(e) {}).catch(function(e) {
                    console.log(e)
                })),
            ...
            sendMsg: function() {
                if (!this.videoEnd) {
                    ...
                    if (e.msgScope) {
                        ...
                        e.comment = "",
                        e.chatWindow.scrollToBottom(),
                        goldlog && goldlog.record("/taobaolive.pclive.comment", "CLK", "", "H1482419031")
                    }
                }
            }
        },
...
, function(e, t, n) {
    ...
    var i = function() {
      ...
      , p = function() {
        function e(t) {
            o(this, e),
            (t = a.default.merge(f, t)).container && (this.cfg = t,
            this.nodes = {
                container: document.querySelector(this.cfg.container)
            },
            this.nodes.commentOuter = e._createDiv(this.nodes.container, c),
            this.nodes.commentInner = e._createDiv(this.nodes.commentOuter, u),
            this.nodes.more = e._createDiv(this.nodes.container, d),
            this.nodes.commentOuter.style.wid_checkMoreth = this.nodes.commentOuter.offsetWidth + 30 + "px",
            this.nodes.commentInner.style.width = this.cfg.commentWidth + "px",
            this.nodes.container.className += " " + l,
            this.commentList = [],
            this.commentToPush = [],
            this.bindEvent())
        }
        return i(e, [{
            ...
            value: function() {
                ...
                .bind(this)),
                this.nodes.more.addEventListener("click", function(e) {
                    this.scrollToBottom()
                }
                .bind(this))
            }
            ...
            value: function() {
                ...
                if (!this.cooldown && this.commentToPush.length) {
                    ...
                    this.commentToPush.forEach(function(t) {
                        ...
                        e.cfg.mergeComment && o && n.cfg.shouldMerge && i.cfg.shouldMerge && r.className === o.className && e.nodes.commentInner.removeChild(e.nodes.commentInner.lastChild),
                        e.nodes.commentInner.appendChild(r),
                        e._checkMore(r)
                    }),
                    t && this.scrollToBottom(),
                    this._removeOverflowComment(),
                    this.cooldown = !0,
            ...
            value: function() {
                this.commentList = [],
                this.commentToPush = [],
                this.nodes.commentInner.innerHTML = "",
                this._checkMore()
            }
        }, {
            key: "scrollToBottom",
            ...
            value: function(e) {
                ...
                t.forEach(function(e) {
                    n > e.offsetTop ? e.removeAttribute("data-more") : (e.setAttribute("data-more", "true"),
                    ++r)
                }),
                this.cfg.showMore && r > 0 ? (this.nodes.more.innerHTML = r + "条新评论",
                this.nodes.more.style.display = "block") : this.nodes.more.style.display = "none"
            }
        }], [{
            key: "_createDiv",
            value: function(e, t) {
      ...
      , s = function() {
        ...
        return o(e, [{
            ...
            value: function() {
                ...
                return e.className = "comment " + this.cfg.class,
                e.style.backgroundColor = this.cfg.backgroundColor,
                e.style.borderRadius = this.cfg.borderRadius + "px",
                e.innerHTML = this.cfg.content,
                e
            }
        }]),
        e
...
, function(e, t, n) {
    ...
    var i = function() {
      ...
      , c = function() {
        function e(t) {
            o(this, e),
            (t = t || {}).container || console.warn("未找到 like-anim 容器!"),
            this.cfg = a.default.merge(l, t),
            this.clickHandler = t.clickHandler || function() {}
            ,
            this.initCanvas(t.container)
        }
        return i(e, [{
            key: "initCanvas",
            value: function() {
                ...
                var t = e.clientWidth
                  , n = e.clientHeight;
                if (t && n) {
                    e.className += " live-anim-wrap",
                    this.cfg.canvasWidth = Math.floor(t * this.cfg.visualSizeRatio),
                    this.cfg.canvasHeight = Math.floor(n * this.cfg.visualSizeRatio);
                    var r = document.createElement("canvas");
                    if (r.style.width = t + "px",
                    r.style.height = n + "px",
                    r.setAttribute("id", this.cfg.canvasId),
                    r.setAttribute("width", this.cfg.canvasWidth),
                    r.setAttribute("height", this.cfg.canvasHeight),
                    this.cxt = r.getContext("2d"),
                    this.cxt.globalAlpha = this.cfg.canvasIconOpacity,
                    e.appendChild(r),
                    this.cfg.showLikeBtn) {
                        var o = document.createElement("div");
                        o.style.backgroundImage = "url('" + this.cfg.likeBtnImg + "')",
                        o.style.width = this.cfg.likeBtnWidth + "px",
                        o.style.height = this.cfg.likeBtnHeight + "px",
                        o.style.marginLeft = -this.cfg.likeBtnWidth / 2 + "px",
                        o.className = this.cfg.likeBtnClass,
                        o.setAttribute("id", this.cfg.likeBtnId),
                        o.addEventListener("click", this.clickHandler),
                        e.appendChild(o)
                    }
                    this.initComplete = !0,
                    this.giftArr = []
                ...
                if (this.initComplete && !(this.giftArr.length > this.cfg.giftNumberLimit)) {
                    if (!(e = e || {}).iconSrc) {
                        if (!this.cfg.icons.length)
                            return;
                        this.i = this.i ? (this.i + 1) % this.cfg.icons.length : 1,
                        e.iconSrc = this.cfg.icons[this.i]
                    }
                    e = a.default.merge(this.cfg, e);
                    var t = new s.default(e);
                    this.giftArr.push(t),
            ...
            value: function() {
                ...
                if (!this.animFrame) {
                    this.animFrame = window.requestAnimFrame(function t() {
                        e.cxt.clearRect(0, 0, e.cfg.canvasWidth, e.cfg.canvasHeight),
                        e.recycle(),
                        e.giftArr.length ? (e.giftArr.forEach(function(e) {
                            e.move()
                        }),
        ...
        return r(e, [{
            ...
            value: function() {
                ...
                this.iconElem.onload = function() {
                    ...
                    e.cxt = t.getContext("2d"),
                    e.x = (e.cfg.canvasWidth - e.cfg.iconWidth) / 2,
                    e.y = e.cfg.canvasHeight - e.cfg.iconHeight - 40,
                    e.directLeft = Math.random() > .5,
                    e.xSpeed = 1 - (1 - 2 * Math.random()) * e.cfg.xSpeedRandomRange,
                    e.ySpeed = 1 - (1 - 2 * Math.random()) * e.cfg.ySpeedRandomRange,
                    e.maxHorizontalOffset = 1 - (1 - Math.random()) * e.cfg.xLimitRandomRange,
                    e.maxVerticalOffset = 1 - (1 - Math.random()) * e.cfg.yLimitRandomRange,
                    e.cxt.drawImage(e.iconElem, e.x, e.y, e.cfg.iconWidth, e.cfg.iconHeight)
                }
                ,
            ...
            value: function() {
                ...
                if (this.cxt && !this.destroy) {
                    ...
                    this.directLeft ? this.x - t >= this.cfg.canvasWidth * (1 - this.maxHorizontalOffset) / 2 ? this.x -= t : (this.directLeft = !this.directLeft,
                    this.maxHorizontalOffset *= this.cfg.xLimitAttenuationRate) : this.x + this.cfg.iconWidth + t <= this.cfg.canvasWidth * (1 + this.maxHorizontalOffset) / 2 ? this.x += t : (this.directLeft = !this.directLeft,
    ...
    (function() {
        ...
        var n = function(e) {
          ...
          , c = function(e, t) {
            ...
            if (n(e))
                p = e.length,
                u = "charForLoopStrategy" === t ? s(e) : "regexStrategy" === t ? l(e) : p > 32 ? l(e) : s(e);
            else if (i(e) || a(e))
                u = e;
            else if (r(e))
                for (u = [],
        ...
        methods: {
            scrollToFix: function() {
                ...
                window.addEventListener("scroll", function() {
                    ...
                    o > t && o + r - 20 < n ? (e.style.position = "fixed",
                    e.style.top = "0px") : (e.style.position = "absolute",
                    e.style.top = "auto")
                })
            },
            activeScroll: function() {
